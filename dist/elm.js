...
{
	if (region.c$.bj === region.$7.bj)
	{
		return 'on line ' + region.c$.bj;
	}
	return 'on lines ' + region.c$.bj + ' through ' + region.$7.bj;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { eM: 'hidden', ew: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { eM: 'mozHidden', ew: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { eM: 'msHidden', ew: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { eM: 'webkitHidden', ew: 'webkitvisibilitychange' }
		: { eM: 'hidden', ew: 'visibilitychange' };
}
...
function _Browser_getViewport()
{
	return {
		...
		ej: {
			...
			em: _Browser_doc.documentElement.clientWidth,
...
function _Browser_getScene()
{
	...
	return {
		em: Math.max(body.scrollWidth, body.offsetWidth, elem.scrollWidth, elem.offsetWidth, elem.clientWidth),
...
var $author$project$Main$init = {
	bT: _List_Nil,
	bD: $elm_community$graph$Graph$empty,
	b6: {er: 4, eF: 1, eW: 10},
	bF: '',
	cP: _List_Nil
};
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {du: fragment, dw: host, dT: path, dV: port_, dZ: protocol, d_: query};
	});
...
var $elm$browser$Browser$sandbox = function (impl) {
	return _Browser_element(
		{
			eP: function (_v0) {
				return _Utils_Tuple2(impl.eP, $elm$core$Platform$Cmd$none);
			},
			fc: function (_v1) {
...
var $elm_community$graph$Graph$NodeContext = F3(
	function (node, incoming, outgoing) {
		return {eO: incoming, eV: node, e2: outgoing};
	});
				...
				return $elm_community$intdict$IntDict$Inner(
					{
						...
						h: p,
						e: r,
						cU: $elm_community$intdict$IntDict$size(l) + $elm_community$intdict$IntDict$size(r)
					});
			}
		}
	});
...
var $elm_community$intdict$IntDict$lcp = F2(
	function (x, y) {
		...
		return {aL: branchingBit, _: prefixBits};
	});
...
var $elm_community$intdict$IntDict$prefixMatches = F2(
	function (p, n) {
		return _Utils_eq(
			n & $elm_community$intdict$IntDict$higherBitMask(p.aL),
			p._);
	});
var $elm_community$intdict$IntDict$update = F3(
	function (key, alter, dict) {
		...
		switch (dict.$) {
			...
			case 1:
				var l = dict.a;
				return _Utils_eq(l.dE, key) ? alteredNode(
					$elm$core$Maybe$Just(l.eh)) : A2(
					join,
					_Utils_Tuple2(
						key,
						alteredNode($elm$core$Maybe$Nothing)),
					_Utils_Tuple2(l.dE, dict));
			default:
				var i = dict.a;
	...
	function (key, dict) {
		...
		while (true) {
			switch (dict.$) {
				...
				case 1:
					var l = dict.a;
					return _Utils_eq(l.dE, key) ? $elm$core$Maybe$Just(l.eh) : $elm$core$Maybe$Nothing;
				default:
					var i = dict.a;
...
var $elm_community$graph$Graph$fromNodesAndEdges = F2(
	function (nodes_, edges_) {
			...
			function (edge, rep) {
				var updateOutgoing = function (ctx) {
					return _Utils_update(
						ctx,
						{
							e2: A3($elm_community$intdict$IntDict$insert, edge.au, edge.ch, ctx.e2)
						});
				};
				var updateIncoming = function (ctx) {
					return _Utils_update(
						ctx,
						{
							eO: A3($elm_community$intdict$IntDict$insert, edge.an, edge.ch, ctx.eO)
						});
				};
				return A3(
					$elm_community$intdict$IntDict$update,
		...
		var addEdgeIfValid = F2(
			function (edge, rep) {
				return (A2($elm_community$intdict$IntDict$member, edge.an, rep) && A2($elm_community$intdict$IntDict$member, edge.au, rep)) ? A2(addEdge, edge, rep) : rep;
			});
		return A3($elm$core$List$foldl, addEdgeIfValid, nodeRep, edges_);
	});
var $author$project$Types$Relation$toEdge = function (rel) {
	return {an: rel.an, ch: rel, au: rel.au};
};
var $author$project$Types$Agent$toNode = function (agent) {
	return {bE: agent.bE, ch: agent};
};
var $author$project$Parsers$GossipGraph$fromAgentsAndRelations = F2(
	function (agents, relations) {
		var nodes = A2($elm$core$List$map, $author$project$Types$Agent$toNode, agents);
		var edges = A2($elm$core$List$map, $author$project$Types$Relation$toEdge, relations);
...
var $author$project$Parsers$GossipGraph$parseAgents = function (input) {
	return A2(
		$elm$core$List$indexedMap,
		F2(
			function (index, name) {
				return {bE: index, cw: name};
			}),
		$author$project$Utils$List$distinct(
			$elm$core$String$toList(
				$elm$core$String$toUpper(
					A2($elm$core$String$filter, $elm$core$Char$isAlpha, input)))));
};
var $author$project$Types$Relation$Number = 0;
var $author$project$Types$Relation$Secret = 1;
...
var $author$project$Parsers$GossipGraph$knowledgeToIndices = F2(
	function (agents, input) {
		return A2(
			$elm$core$List$map,
			function ($) {
				return $.bE;
...
var $author$project$Parsers$GossipGraph$findRelationTuples = F2(
	function (agents, knowledge) {
		return A2(
			$elm$core$List$filter,
			function (_v0) {
				var a = _v0.a;
			...
			$elm$core$List$concat(
				A2(
					...
					A2(
						$elm$core$List$map,
						$author$project$Parsers$GossipGraph$knowledgeToIndices(agents),
						knowledge))));
	});
var $author$project$Parsers$GossipGraph$toRelations = F2(
	function (kind, tuples) {
		var removeDuplicates = function (relations) {
			var removeDuplicatesAcc = F2(
				function (withDups, withoutDups) {
					removeDuplicatesAcc:
					while (true) {
						if (!withDups.b) {
							return withoutDups;
							...
							var rel = withDups.a;
							var withDupsRest = withDups.b;
							if (rel.aA && A2(
								$elm$core$List$any,
								function (r) {
									return (_Utils_eq(r.an, rel.an) && (_Utils_eq(r.au, rel.au) && (!r.aA))) || (_Utils_eq(r.an, rel.au) && (_Utils_eq(r.au, rel.an) && (!r.aA)));
								},
								relations)) {
								var $temp$withDups = withDupsRest,
									$temp$withoutDups = withoutDups;
								withDups = $temp$withDups;
								withoutDups = $temp$withoutDups;
								continue removeDuplicatesAcc;
							} else {
								var $temp$withDups = withDupsRest,
									$temp$withoutDups = A2($elm$core$List$cons, rel, withoutDups);
								withDups = $temp$withDups;
								withoutDups = $temp$withoutDups;
								continue removeDuplicatesAcc;
							}
			...
			return A2(removeDuplicatesAcc, relations, _List_Nil);
		};
		var toRelationsAcc = F2(
			function (tups, relations) {
				toRelationsAcc:
				while (true) {
					if (!tups.b) {
						...
						if (A2(
							$elm$core$List$any,
							function (r) {
								return r.aA && (_Utils_eq(r.an, to) && _Utils_eq(r.au, from));
							},
							relations)) {
							var $temp$tups = xs,
								$temp$relations = A2(
								$elm$core$List$cons,
								{aA: false, an: to, bH: kind, au: from},
								relations);
							tups = $temp$tups;
							relations = $temp$relations;
							continue toRelationsAcc;
						} else {
							var $temp$tups = xs,
								$temp$relations = A2(
								$elm$core$List$cons,
								{aA: true, an: from, bH: kind, au: to},
								relations);
							tups = $temp$tups;
							relations = $temp$relations;
							continue toRelationsAcc;
		...
		return A2(toRelationsAcc, tuples, _List_Nil);
	});
var $author$project$Parsers$GossipGraph$parseRelations = F2(
	function (input, agents) {
		var secretRelations = A2(
			$author$project$Parsers$GossipGraph$toRelations,
			1,
			A2(
				$author$project$Parsers$GossipGraph$findRelationTuples,
				agents,
				A2(
					$elm$core$List$map,
					$elm$core$String$filter($elm$core$Char$isUpper),
					A2($elm$core$String$split, ' ', input))));
		var numberRelations = A2(
			$author$project$Parsers$GossipGraph$toRelations,
			0,
			A2(
				$author$project$Parsers$GossipGraph$findRelationTuples,
				...
				A2(
					$elm$core$List$map,
					$elm$core$String$filter($elm$core$Char$isLower),
					A2($elm$core$String$split, ' ', input))));
		return A2($elm$core$List$append, numberRelations, secretRelations);
	});
var $author$project$Parsers$GossipGraph$parse = function (input) {
	var agents = $author$project$Parsers$GossipGraph$parseAgents(input);
	var relations = A2($author$project$Parsers$GossipGraph$parseRelations, input, agents);
	return _Utils_Tuple2(agents, relations);
};
var $author$project$Main$update = F2(
	function (msg, model) {
		var input = msg;
		var _v1 = $author$project$Parsers$GossipGraph$parse(input);
		var agents = _v1.a;
		var relations = _v1.b;
		var graph = A2($author$project$Parsers$GossipGraph$fromAgentsAndRelations, agents, relations);
		return _Utils_update(
			model,
			{bT: agents, bD: graph, bF: input, cP: relations});
	});
...
var $gampleman$elm_visualization$Force$entity = F2(
	function (index, a) {
		...
		return {
			...
			ab: 0.0,
			ac: 0.0,
			O: radius * $elm$core$Basics$cos(angle),
			P: radius * $elm$core$Basics$sin(angle)
		};
	});
var $author$project$Renderers$GossipGraph$agentToEntity = function (agent) {
	return A2($gampleman$elm_visualization$Force$entity, agent.bE, agent);
};
...
var $author$project$Renderers$GossipGraph$arrowHeads = function (settings) {
	var width = settings.er;
	var height = settings.er;
	var yMid = height / 2;
	return _List_fromArray(
		[
			A2(
...
var $ianmackenzie$elm_geometry$Vector2d$from = F2(
	function (_v0, _v1) {
		var p1 = _v0;
		var p2 = _v1;
		return {O: p2.O - p1.O, P: p2.P - p1.P};
	});
...
var $ianmackenzie$elm_geometry$Vector2d$plus = F2(
	function (_v0, _v1) {
		var v2 = _v0;
		var v1 = _v1;
		return {O: v1.O + v2.O, P: v1.P + v2.P};
	});
...
var $ianmackenzie$elm_geometry$Vector2d$zero = {O: 0, P: 0};
var $gampleman$elm_visualization$Force$ManyBody$applyForce = F4(
	function (alpha, theta, qtree, vertex) {
		var isFarAway = function (treePart) {
			var distance = A2($ianmackenzie$elm_geometry$Point2d$distanceFrom, vertex.e3, treePart.db.e3);
			var _v2 = $ianmackenzie$elm_geometry$BoundingBox2d$dimensions(treePart.eu);
			var width = _v2.a;
			return _Utils_cmp(
		...
		var calculateVelocity = F2(
			function (target, source) {
				var delta = A2($ianmackenzie$elm_geometry$Vector2d$from, target.e3, source.e3);
				var len = $ianmackenzie$elm_units_prefixed$Units$Pixels$inPixels(
					$ianmackenzie$elm_geometry$Vector2d$length(delta));
				var weight = (source.a0 * alpha) / A2($elm$core$Basics$pow, len, 2);
		...
		var useAggregate = function (treePart) {
			return A2(calculateVelocity, vertex, treePart.db);
		};
		switch (qtree.$) {
			case 0:
				...
				if (isFarAway(leaf)) {
					...
					var applyForceFromPoint = F2(
						function (point, accum) {
							return _Utils_eq(point.dE, vertex.dE) ? accum : A2(
...
var $gampleman$elm_visualization$Force$ManyBody$constructSuperPoint = F2(
	function (first, rest) {
		var initialStrength = first.a0;
		var initialPoint = $ianmackenzie$elm_geometry$Point2d$coordinates(first.e3);
		var folder = F2(
			function (point, _v3) {
				var _v4 = _v3.a;
				var accumX = _v4.a;
				...
				var strength = _v3.b;
				var size = _v3.c;
				var _v2 = $ianmackenzie$elm_geometry$Point2d$coordinates(point.e3);
				var x = _v2.a;
				var y = _v2.b;
...
var $gampleman$elm_visualization$Force$ManyBody$config = {
	ey: $gampleman$elm_visualization$Force$ManyBody$constructSuperPoint,
	ez: $gampleman$elm_visualization$Force$ManyBody$constructSuperPoint,
	fj: function ($) {
		return $.e3;
	}
};
...
var $ianmackenzie$elm_geometry$BoundingBox2d$fromExtrema = function (given) {
	return (A2($ianmackenzie$elm_units$Quantity$lessThanOrEqualTo, given.aS, given.aU) && A2($ianmackenzie$elm_units$Quantity$lessThanOrEqualTo, given.aT, given.aV)) ? given : {
		aS: A2($ianmackenzie$elm_units$Quantity$max, given.aU, given.aS),
		aT: A2($ianmackenzie$elm_units$Quantity$max, given.aV, given.aT),
		aU: A2($ianmackenzie$elm_units$Quantity$min, given.aU, given.aS),
		aV: A2($ianmackenzie$elm_units$Quantity$min, given.aV, given.aT)
	};
};
...
var $ianmackenzie$elm_geometry$BoundingBox2d$midX = function (_v0) {
	var boundingBox = _v0;
	return A3($ianmackenzie$elm_units$Quantity$interpolateFrom, boundingBox.aU, boundingBox.aS, 0.5);
};
var $ianmackenzie$elm_geometry$BoundingBox2d$midY = function (_v0) {
	var boundingBox = _v0;
	return A3($ianmackenzie$elm_units$Quantity$interpolateFrom, boundingBox.aV, boundingBox.aT, 0.5);
};
...
var $ianmackenzie$elm_geometry$BoundingBox2d$singleton = function (point) {
	return {
		aS: $ianmackenzie$elm_geometry$Point2d$xCoordinate(point),
		aT: $ianmackenzie$elm_geometry$Point2d$yCoordinate(point),
		aU: $ianmackenzie$elm_geometry$Point2d$xCoordinate(point),
		aV: $ianmackenzie$elm_geometry$Point2d$yCoordinate(point)
	};
};
var $gampleman$elm_visualization$Force$QuadTree$singleton = F2(
	function (toPoint, vertex) {
		return $gampleman$elm_visualization$Force$QuadTree$Leaf(
			{
				db: 0,
				eu: $ianmackenzie$elm_geometry$BoundingBox2d$singleton(
					toPoint(vertex)),
				ex: _Utils_Tuple2(vertex, _List_Nil)
			});
	});
var $ianmackenzie$elm_geometry$BoundingBox2d$union = F2(
	function (firstBox, secondBox) {
		...
		return {
			aS: A2($ianmackenzie$elm_units$Quantity$max, b1.aS, b2.aS),
			aT: A2($ianmackenzie$elm_units$Quantity$max, b1.aT, b2.aT),
			aU: A2($ianmackenzie$elm_units$Quantity$min, b1.aU, b2.aU),
			aV: A2($ianmackenzie$elm_units$Quantity$min, b1.aV, b2.aV)
		};
	});
	...
	function (toPoint, vertex, qtree) {
		switch (qtree.$) {
					...
					var initial = $gampleman$elm_visualization$Force$QuadTree$Node(
						{
							...
							eu: A2(
								...
								$ianmackenzie$elm_geometry$BoundingBox2d$singleton(
									toPoint(vertex))),
							eU: $gampleman$elm_visualization$Force$QuadTree$Empty,
							eY: $gampleman$elm_visualization$Force$QuadTree$Empty,
							fa: $gampleman$elm_visualization$Force$QuadTree$Empty,
							fd: $gampleman$elm_visualization$Force$QuadTree$Empty
						});
					return A3(
						$elm$core$List$foldl,
			...
			default:
				...
				if (A2($ianmackenzie$elm_geometry$BoundingBox2d$contains, point, node.eu)) {
					var _v2 = A2($gampleman$elm_visualization$Force$QuadTree$quadrant, node.eu, point);
					switch (_v2) {
						case 0:
							return $gampleman$elm_visualization$Force$QuadTree$Node(
								{
									db: node.db,
									eu: node.eu,
									eU: A3($gampleman$elm_visualization$Force$QuadTree$insertBy, toPoint, vertex, node.eU),
									eY: node.eY,
									fa: node.fa,
									fd: node.fd
								});
							...
							return $gampleman$elm_visualization$Force$QuadTree$Node(
								{
									...
									eu: node.eu,
									eU: node.eU,
									eY: A3($gampleman$elm_visualization$Force$QuadTree$insertBy, toPoint, vertex, node.eY),
									fa: node.fa,
									fd: node.fd
								});
						default:
							return $gampleman$elm_visualization$Force$QuadTree$Node(
								{
									...
									eY: node.eY,
									fa: node.fa,
									fd: A3($gampleman$elm_visualization$Force$QuadTree$insertBy, toPoint, vertex, node.fd)
								});
					}
				} else {
					var _v3 = $ianmackenzie$elm_geometry$BoundingBox2d$extrema(node.eu);
					var minX = _v3.aU;
					var minY = _v3.aV;
					var maxX = _v3.aS;
					var maxY = _v3.aT;
					var _v4 = $ianmackenzie$elm_geometry$BoundingBox2d$dimensions(node.eu);
					var width = _v4.a;
					var height = _v4.b;
					var _v5 = A2($gampleman$elm_visualization$Force$QuadTree$quadrant, node.eu, point);
					switch (_v5) {
						case 0:
							return $gampleman$elm_visualization$Force$QuadTree$Node(
								{
									db: 0,
									eu: $ianmackenzie$elm_geometry$BoundingBox2d$fromExtrema(
										{
											aS: A2($ianmackenzie$elm_units_prefixed$Units$Quantity$plus, width, maxX),
											aT: A2($ianmackenzie$elm_units_prefixed$Units$Quantity$plus, height, maxY),
											aU: minX,
											aV: minY
										}),
									eU: A2($gampleman$elm_visualization$Force$QuadTree$singleton, toPoint, vertex),
									eY: $gampleman$elm_visualization$Force$QuadTree$Empty,
									fa: $gampleman$elm_visualization$Force$QuadTree$Empty,
									fd: qtree
								});
									...
									eu: $ianmackenzie$elm_geometry$BoundingBox2d$fromExtrema(
										{
											...
											aT: maxY,
											aU: minX,
											aV: A2($ianmackenzie$elm_units_prefixed$Units$Quantity$minus, height, minY)
										}),
									eU: $gampleman$elm_visualization$Force$QuadTree$Empty,
									eY: qtree,
									...
									eu: $ianmackenzie$elm_geometry$BoundingBox2d$fromExtrema(
										{
											aS: maxX,
											aT: A2($ianmackenzie$elm_units_prefixed$Units$Quantity$plus, height, maxY),
											aU: A2($ianmackenzie$elm_units_prefixed$Units$Quantity$minus, width, minX),
											aV: minY
										}),
									eU: $gampleman$elm_visualization$Force$QuadTree$Empty,
									eY: A2($gampleman$elm_visualization$Force$QuadTree$singleton, toPoint, vertex),
									fa: qtree,
									fd: $gampleman$elm_visualization$Force$QuadTree$Empty
								});
						default:
							return $gampleman$elm_visualization$Force$QuadTree$Node(
								{
									...
									eY: $gampleman$elm_visualization$Force$QuadTree$Empty,
									fa: $gampleman$elm_visualization$Force$QuadTree$Empty,
									fd: A2($gampleman$elm_visualization$Force$QuadTree$singleton, toPoint, vertex)
								});
					}
				}
		}
...
var $gampleman$elm_visualization$Force$QuadTree$performAggregate = F2(
	function (config, vanillaQuadTree) {
		var combineAggregates = config.ey;
		var combineVertices = config.ez;
		switch (vanillaQuadTree.$) {
			...
			case 1:
				...
				return $gampleman$elm_visualization$Force$QuadTree$Leaf(
					{
						db: A2(combineVertices, first, rest),
						eu: leaf.eu,
						ex: _Utils_Tuple2(first, rest)
					});
			default:
				var node = vanillaQuadTree.a;
				var newSw = A2($gampleman$elm_visualization$Force$QuadTree$performAggregate, config, node.fd);
				var newSe = A2($gampleman$elm_visualization$Force$QuadTree$performAggregate, config, node.fa);
				var newNw = A2($gampleman$elm_visualization$Force$QuadTree$performAggregate, config, node.eY);
				var newNe = A2($gampleman$elm_visualization$Force$QuadTree$performAggregate, config, node.eU);
				var subresults = A2(
	...
	function (alpha, theta, strengths, points) {
		var vertices = A2(
			...
			function (_v1) {
				...
				return {
					dE: key,
					e3: A2($ianmackenzie$elm_geometry$Point2d$pixels, x, y),
					a0: strength,
					by: $ianmackenzie$elm_geometry$Vector2d$zero
				};
			},
		...
		var updater = F2(
			function (newVertex, maybePoint) {
				if (maybePoint.$ === 1) {
					...
					var dv = $ianmackenzie$elm_geometry$Vector2d$toPixels(newVertex.by);
					return $elm$core$Maybe$Just(
						_Utils_update(
							point,
							{ab: point.ab + dv.O, ac: point.ac + dv.P}));
				}
			});
				...
				var _v1 = A3(
					...
					F3(
						function (_v2, ent, _v3) {
							var sx0 = _v3.a;
							var sy0 = _v3.b;
							return _Utils_Tuple2(sx0 + ent.O, sy0 + ent.P);
						}),
					_Utils_Tuple2(0, 0),
					entities);
				var sumx = _v1.a;
							...
							F2(
								function (_v5, ents) {
									...
									if ((!_v6.a.$) && (!_v6.b.$)) {
										...
										var y = ((targetNode.P + targetNode.ac) - sourceNode.P) - sourceNode.ac;
										var x = ((targetNode.O + targetNode.ab) - sourceNode.O) - sourceNode.ab;
										...
										return A3(
											...
											$elm$core$Maybe$map(
												function (tn) {
													return _Utils_update(
														tn,
														{ab: tn.ab + ((x * l) * (1 - bias)), ac: tn.ac + ((y * l) * (1 - bias))});
												}),
											A3(
												$elm$core$Dict$update,
												target,
												$elm$core$Maybe$map(
													function (sn) {
														return _Utils_update(
															sn,
															{ab: sn.ab - ((x * l) * bias), ac: sn.ac - ((y * l) * bias)});
													}),
												ents));
									} else {
										var otherwise = _v6;
...
var $gampleman$elm_visualization$Force$tick = F2(
	function (_v0, nodes) {
		...
		var updateEntity = function (ent) {
			return _Utils_update(
				ent,
				{ab: ent.ab * state.bz, ac: ent.ac * state.bz, O: ent.O + (ent.ab * state.bz), P: ent.P + (ent.ac * state.bz)});
		};
		var dictNodes = A3(
			$elm$core$List$foldl,
			function (node) {
				return A2($elm$core$Dict$insert, node.bE, node);
			},
			$elm$core$Dict$empty,
			nodes);
		var alpha = state.aK + ((state.dd - state.aK) * state.bU);
		var newNodes = A3(
			$elm$core$List$foldl,
...
var $author$project$Renderers$GossipGraph$getLinks = function (graph) {
	return A2(
		$elm$core$List$map,
		function (edge) {
			return _Utils_Tuple2(edge.an, edge.au);
		},
		...
		return A2(
			...
			A2(
				...
				function (_v0) {
					...
					var strength = _v0.a0;
					return {
						bY: count(source) / (count(source) + count(target)),
						bd: distance,
						a_: source,
						a0: A2(
							$elm$core$Maybe$withDefault,
...
var $gampleman$elm_visualization$Force$links = A2(
	...
	$elm$core$List$map(
		function (_v0) {
			var source = _v0.a;
			var target = _v0.b;
			return {bd: 30, a_: source, a0: $elm$core$Maybe$Nothing, aa: target};
		}),
		...
		var updateOutgoingEdge = F2(
			function (upd, node) {
				return _Utils_update(
					node,
					{
						e2: A3($elm_community$intdict$IntDict$update, nodeId, upd, node.e2)
					});
			});
		var updateIncomingEdge = F2(
			function (upd, node) {
				return _Utils_update(
					node,
					{
						eO: A3($elm_community$intdict$IntDict$update, nodeId, upd, node.eO)
					});
			});
		var flippedFoldl = F3(
			function (f, dict, acc) {
...
var $elm_community$graph$Graph$emptyDiff = {eO: $elm_community$intdict$IntDict$empty, e2: $elm_community$intdict$IntDict$empty};
	...
	function (old, _new) {
		...
		if (_v0.a.$ === 1) {
			if (_v0.b.$ === 1) {
				...
				var ins = _v0.b.a;
				return {
					eO: A3(collect, $elm_community$graph$Graph$Insert, ins.e2, $elm_community$intdict$IntDict$empty),
					e2: A3(collect, $elm_community$graph$Graph$Insert, ins.eO, $elm_community$intdict$IntDict$empty)
				};
			}
		} else {
			if (_v0.b.$ === 1) {
				...
				var _v3 = _v0.b;
				return {
					eO: A3(collect, $elm_community$graph$Graph$Remove, rem.e2, $elm_community$intdict$IntDict$empty),
					e2: A3(collect, $elm_community$graph$Graph$Remove, rem.eO, $elm_community$intdict$IntDict$empty)
				};
			} else {
				var rem = _v0.a.a;
				var ins = _v0.b.a;
				return _Utils_eq(rem, ins) ? $elm_community$graph$Graph$emptyDiff : {
					eO: A3(
						...
						ins.e2,
						A3(collect, $elm_community$graph$Graph$Remove, rem.e2, $elm_community$intdict$IntDict$empty)),
					e2: A3(
						collect,
						$elm_community$graph$Graph$Insert,
						ins.eO,
						A3(collect, $elm_community$graph$Graph$Remove, rem.eO, $elm_community$intdict$IntDict$empty))
				};
			}
		}
	});
		...
		var wrappedUpdater = function (rep) {
			...
			var filterInvalidEdges = function (ctx) {
				return $elm_community$intdict$IntDict$filter(
					F2(
						function (id, _v0) {
							return _Utils_eq(id, ctx.eV.bE) || A2($elm_community$intdict$IntDict$member, id, rep);
						}));
			};
			var cleanUpEdges = function (ctx) {
				return _Utils_update(
					ctx,
					{
						eO: A2(filterInvalidEdges, ctx, ctx.eO),
				...
				while (true) {
					...
					if (!maybeContext.$) {
						...
						var $temp$acc1 = A2(f, ctx, acc1),
							$temp$graph1 = A2($elm_community$graph$Graph$remove, ctx.eV.bE, graph1);
						acc1 = $temp$acc1;
						graph1 = $temp$graph1;
						continue go;
					} else {
...
var $author$project$Renderers$GossipGraph$radialOffsetValue = F4(
	function (source, target, xoff, yoff) {
		var _v0 = _Utils_Tuple2(
			_Utils_cmp(source.O, target.O) > 0,
			_Utils_cmp(source.P, target.P) > 0);
		if (_v0.a) {
			if (_v0.b) {
				return _Utils_Tuple2(source.O - xoff, source.P - yoff);
			} else {
				return _Utils_Tuple2(source.O - xoff, source.P + yoff);
			}
		} else {
...
var $author$project$Renderers$GossipGraph$radialOffset = F4(
	function (source, target, sourceOffset, targetOffset) {
		var dy = $elm$core$Basics$abs(source.P - target.P);
		var dx = $elm$core$Basics$abs(source.O - target.O);
		...
		var newSource = A4($author$project$Renderers$GossipGraph$radialOffsetValue, source, target, sourceOffsetX, sourceOffsetY);
		var targetOffsetX = targetOffset * $elm$core$Basics$cos(angle);
		var targetOffsetY = targetOffset * $elm$core$Basics$sin(angle);
		var newTarget = A4($author$project$Renderers$GossipGraph$radialOffsetValue, target, source, targetOffsetX, targetOffsetY);
...
var $author$project$Renderers$GossipGraph$renderEdgeDirected = F4(
	function (settings, extraAttributes, source, target) {
		var r2 = settings.eW + settings.er;
		var r1 = settings.eW;
		var _v0 = A4($author$project$Renderers$GossipGraph$radialOffset, source, target, r1, r2);
		var src = _v0.a;
		var tgt = _v0.b;
		return A2(
			...
			_Utils_ap(
				_List_fromArray(
					[
						...
						$elm_community$typed_svg$TypedSvg$Types$px(settings.eF)),
...
var $author$project$Renderers$GossipGraph$fractionalModBy = F2(
	function (modulus, x) {
...
var $author$project$Renderers$GossipGraph$angularOffset = F3(
	function (_v0, offset, node) {
		...
		var r = _v1.a;
		var theta = _v1.b;
		var newAngle = A2($author$project$Renderers$GossipGraph$fractionalModBy, 2 * $elm$core$Basics$pi, theta - offset);
		var _v2 = $elm$core$Basics$fromPolar(
			_Utils_Tuple2(r, newAngle));
		var newX = _v2.a;
		var newY = _v2.b;
		return _Utils_Tuple2(node.O + newX, node.P + newY);
	});
var $author$project$Renderers$GossipGraph$renderEdgeOffset = F4(
	function (settings, extraAttributes, source, target) {
		var r2 = settings.eW + settings.er;
		var r1 = settings.eW;
		var _v0 = A4($author$project$Renderers$GossipGraph$radialOffset, source, target, r1, r2);
		var newSource = _v0.a;
		var newTarget = _v0.b;
		var src = A3($author$project$Renderers$GossipGraph$angularOffset, newSource, $elm$core$Basics$pi / 16, source);
		var tgt = A3($author$project$Renderers$GossipGraph$angularOffset, newTarget, (-$elm$core$Basics$pi) / 16, target);
		return A2(
			$elm_community$typed_svg$TypedSvg$line,
			_Utils_ap(
				_List_fromArray(
...
var $elm_community$typed_svg$TypedSvg$Attributes$markerStart = $elm_community$typed_svg$TypedSvg$Core$attribute('marker-start');
var $author$project$Renderers$GossipGraph$renderEdgeUndirected = F4(
	function (settings, extraAttributes, source, target) {
		var r = settings.eW + settings.er;
		var _v0 = A4($author$project$Renderers$GossipGraph$radialOffset, source, target, r, r);
		var src = _v0.a;
		var tgt = _v0.b;
		return A2(
			$elm_community$typed_svg$TypedSvg$line,
			_Utils_ap(
				_List_fromArray(
					[
						...
						$elm_community$typed_svg$TypedSvg$Types$Paint($avh4$elm_color$Color$black)),
						$elm_community$typed_svg$TypedSvg$Attributes$markerEnd('url(#arrow-head-end)'),
						$elm_community$typed_svg$TypedSvg$Attributes$markerStart('url(#arrow-head-start)'),
						$elm_community$typed_svg$TypedSvg$Attributes$x1(
						$elm_community$typed_svg$TypedSvg$Types$px(src.a)),
						$elm_community$typed_svg$TypedSvg$Attributes$y1(
						$elm_community$typed_svg$TypedSvg$Types$px(src.b)),
...
var $author$project$Renderers$GossipGraph$renderEdge = F3(
	function (graph, settings, edge) {
		...
		var source = retrieveEntity(
			A2($elm_community$graph$Graph$get, edge.an, graph));
		var target = retrieveEntity(
			A2($elm_community$graph$Graph$get, edge.au, graph));
		var dashed = (!edge.ch.bH) ? _List_fromArray(
			[
				$elm_community$typed_svg$TypedSvg$Attributes$strokeDasharray('2')
			]) : _List_Nil;
		return A2(
			$elm$core$List$any,
			function (e) {
				return _Utils_eq(edge.an, e.au) && _Utils_eq(edge.au, e.an);
			},
			$elm_community$graph$Graph$edges(graph)) ? A4($author$project$Renderers$GossipGraph$renderEdgeOffset, settings, dashed, source, target) : ((!edge.ch.aA) ? A4($author$project$Renderers$GossipGraph$renderEdgeUndirected, settings, dashed, source, target) : A4($author$project$Renderers$GossipGraph$renderEdgeDirected, settings, dashed, source, target));
	});
...
var $author$project$Renderers$GossipGraph$renderNode = F2(
				...
				[
					...
					_List_fromArray(
						[
							...
							$elm_community$typed_svg$TypedSvg$Types$px(settings.eW)),
							...
							$elm_community$typed_svg$TypedSvg$Types$px(node.ch.O)),
							$elm_community$typed_svg$TypedSvg$Attributes$cy(
							$elm_community$typed_svg$TypedSvg$Types$px(node.ch.P))
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									...
									$elm$core$String$fromChar(node.ch.eh.cw))
								]))
						])),
					A2(
					...
					_List_fromArray(
						[
							...
							$elm_community$typed_svg$TypedSvg$Types$px(settings.eW / 2))
						]),
					_List_fromArray(
						[
							$elm_community$typed_svg$TypedSvg$Core$text(
...
var $gampleman$elm_visualization$Force$simulation = function (forces) {
	return {
		aK: 1.0,
		bU: 1 - A2($elm$core$Basics$pow, 0.001, 1 / 300),
		dd: 0.0,
		dt: forces,
		ct: 0.001,
		bz: 0.6
...
var $author$project$Renderers$GossipGraph$updateContextWithValue = F2(
...
var $author$project$Renderers$GossipGraph$updateGraphWithList = function () {
	var graphUpdater = function (value) {
		return $elm$core$Maybe$map(
			function (ctx) {
				return A2($author$project$Renderers$GossipGraph$updateContextWithValue, ctx, value);
			});
	};
...
var $author$project$Renderers$GossipGraph$render = F2(
	function (graph, settings) {
		var entityGraph = A2($elm_community$graph$Graph$mapNodes, $author$project$Renderers$GossipGraph$agentToEntity, graph);
		var forces = _List_fromArray(
			[
				$gampleman$elm_visualization$Force$links(
				$author$project$Renderers$GossipGraph$getLinks(entityGraph)),
				A2(
				...
				A2($gampleman$elm_visualization$Force$center, 200, 200)
			]);
		var computedGraph = A2(
			$author$project$Renderers$GossipGraph$updateGraphWithList,
			entityGraph,
			A2(
		...
		return A2(
			...
			_List_fromArray(
				[
					A4($elm_community$typed_svg$TypedSvg$Attributes$viewBox, 0, 0, 400, 400)
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_Nil,
					$author$project$Renderers$GossipGraph$arrowHeads(settings)),
					A2(
					$elm_community$typed_svg$TypedSvg$g,
					_List_fromArray(
						[
					...
					A2(
						$elm$core$List$map,
						A2($author$project$Renderers$GossipGraph$renderEdge, computedGraph, settings),
					...
					A2(
						$elm$core$List$map,
						$author$project$Renderers$GossipGraph$renderNode(settings),
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_Nil),
				A2($author$project$Renderers$GossipGraph$render, model.bD, model.b6)
			]));
};
var $author$project$Main$main = $elm$browser$Browser$sandbox(
	{eP: $author$project$Main$init, fm: $author$project$Main$update, fn: $author$project$Main$view});
