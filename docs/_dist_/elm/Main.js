...
{
	if (region.dw.bD === region.dW.bD)
	{
		return 'on line ' + region.dw.bD;
	}
	return 'on lines ' + region.dw.bD + ' through ' + region.dW.bD;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { fo: 'hidden', e4: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { fo: 'mozHidden', e4: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { fo: 'msHidden', e4: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { fo: 'webkitHidden', e4: 'webkitvisibilitychange' }
		: { fo: 'hidden', e4: 'visibilitychange' };
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {d$: fragment, d1: host, es: path, eu: port_, ey: protocol, ez: query};
	});
...
var $author$project$GossipProtocol$BooleanFormula$cata = F3(
	function (f, acc, formula) {
		if (!formula.$) {
			return acc;
		} else {
			var id = formula.a;
			...
			return A4(
				...
				id,
				label,
				A3($author$project$GossipProtocol$BooleanFormula$cata, f, acc, left),
				A3($author$project$GossipProtocol$BooleanFormula$cata, f, acc, right));
		}
	});
var $author$project$GossipGraph$Call$includes = F2(
	function (call, agent) {
		return _Utils_eq(call.ar, agent) || _Utils_eq(call.aX, agent);
	});
...
var $author$project$GossipProtocol$Conditions$Constituents$hasCalled = F3(
	function (x, y, sequence) {
		return A2(
			$elm$core$List$any,
			function (c) {
				return _Utils_eq(c.ar, x) && _Utils_eq(c.aX, y);
			},
			sequence);
	});
...
var $author$project$GossipGraph$Relation$atLeast = F2(
	function (kind, rel) {
		return (!kind) || (_Utils_eq(rel.ec, kind) || ((!kind) && (rel.ec === 1)));
	});
var $author$project$GossipGraph$Relation$knows = F4(
	function (x, y, kind, relation) {
		return _Utils_eq(relation.ar, x) && (_Utils_eq(relation.aX, y) && A2($author$project$GossipGraph$Relation$atLeast, kind, relation));
	});
...
var $author$project$GossipProtocol$Conditions$Constituents$lastFrom = F2(
	function (agent, sequence) {
		...
		if (!_v0.$) {
			var call = _v0.a;
			return _Utils_eq(call.ar, agent);
		} else {
			return false;
		}
	});
var $author$project$GossipProtocol$Conditions$Constituents$lastTo = F2(
	function (agent, sequence) {
		...
		if (!_v0.$) {
			var call = _v0.a;
			return _Utils_eq(call.aX, agent);
		} else {
			return false;
		}
	});
...
var $author$project$GossipProtocol$Conditions$Constituents$wasCalledBy = F3(
	function (x, y, sequence) {
		return A2(
			$elm$core$List$any,
			function (c) {
				return _Utils_eq(c.ar, y) && _Utils_eq(c.aX, x);
			},
			sequence);
	});
var $author$project$GossipProtocol$GossipProtocol$evaluateFormulaAsProtocolCondition = F4(
	function (formula, _v0, relations, sequence) {
		var x = _v0.a;
		var y = _v0.b;
		var transform = F4(
			function (id, label, left, right) {
				if (!label.$) {
					var junction = label.a;
					if (junction === 1) {
						return left || right;
					} else {
						return left && right;
					...
					switch (value) {
						...
						case 2:
							return negate(
								$author$project$GossipProtocol$Conditions$Constituents$empty(sequence));
						case 3:
							return negate(
								A2($author$project$GossipProtocol$Conditions$Constituents$lastTo, x, sigma_x));
						case 4:
							return negate(
								A2($author$project$GossipProtocol$Conditions$Constituents$lastFrom, x, sigma_x));
						case 5:
							return negate(
								A3($author$project$GossipProtocol$Conditions$Constituents$hasCalled, x, y, sigma_x));
						case 6:
							return negate(
								A3($author$project$GossipProtocol$Conditions$Constituents$wasCalledBy, x, y, sigma_x));
						default:
							return negate(
								A3($author$project$GossipProtocol$Conditions$Constituents$knowsSecret, x, y, relations));
					}
				}
			});
		return A3($author$project$GossipProtocol$BooleanFormula$cata, transform, true, formula);
	});
var $author$project$GossipProtocol$BooleanFormula$Constituent = F2(
	function (a, b) {
		return {$: 1, a: a, b: b};
	});
var $author$project$GossipProtocol$BooleanFormula$NotNegated = 1;
var $author$project$GossipProtocol$Conditions$Constituents$Verum = 0;
var $author$project$GossipProtocol$BooleanFormula$Leaf = {$: 0};
var $author$project$GossipProtocol$BooleanFormula$Node = F4(
	function (a, b, c, d) {
		return {$: 1, a: a, b: b, c: c, d: d};
	});
var $author$project$GossipProtocol$BooleanFormula$singleton = F2(
	function (index, node) {
		return A4($author$project$GossipProtocol$BooleanFormula$Node, index, node, $author$project$GossipProtocol$BooleanFormula$Leaf, $author$project$GossipProtocol$BooleanFormula$Leaf);
	});
var $author$project$GossipProtocol$Conditions$Predefined$formulaAny = A2(
	$author$project$GossipProtocol$BooleanFormula$singleton,
	0,
	A2($author$project$GossipProtocol$BooleanFormula$Constituent, 1, 0));
	...
	return _Utils_Tuple2(
		{
			...
			aq: $elm$core$Result$Ok(_List_Nil),
			aC: '',
			a2: false,
			b2: $norpan$elm_html5_drag_drop$Html5$DragDrop$init,
			a3: $elm$core$Maybe$Nothing,
			by: 3,
			E: $author$project$GossipProtocol$Conditions$Predefined$formulaAny,
			t: $elm$core$Result$Ok($elm_community$graph$Graph$empty),
			cD: {bq: 6, cs: 400, ct: 400, b3: 1.5, aT: 20},
			u: $zwilias$elm_rosetree$Tree$singleton($author$project$GossipProtocol$GossipProtocol$Root),
			G: $elm_community$graph$Graph$empty,
			ad: 0,
			aE: '',
			ae: '',
			W: {cv: _List_Nil, ch: '', bo: false},
			X: $author$project$GossipProtocol$GossipProtocol$evaluateFormulaAsProtocolCondition($author$project$GossipProtocol$Conditions$Predefined$formulaAny),
			I: 'any',
			bH: $elm$core$Result$Ok(_List_Nil)
		},
...
var $author$project$GossipGraph$Call$fromList = function (agents) {
	...
	if ($elm$core$List$length(agents) > 2) {
		...
		if ((!_v0.a.$) && (!_v0.b.$)) {
			var f = _v0.a.a;
			var t = _v0.b.a;
			return _Utils_eq(f.b5, t.b5) ? $elm$core$Result$Err('An agent cannot call itself.') : $elm$core$Result$Ok(
				{ar: f.b5, aX: t.b5});
		} else {
			return $elm$core$Result$Err('A call must contain two agents.');
		}
...
var $elm_community$intdict$IntDict$lcp = F2(
	function (x, y) {
		...
		return {a1: branchingBit, an: prefixBits};
	});
...
var $elm_community$intdict$IntDict$prefixMatches = F2(
	function (p, n) {
		return _Utils_eq(
			n & $elm_community$intdict$IntDict$higherBitMask(p.a1),
			p.an);
	});
var $elm_community$intdict$IntDict$update = F3(
	function (key, alter, dict) {
		...
		switch (dict.$) {
			...
			case 1:
				var l = dict.a;
				return _Utils_eq(l.eb, key) ? alteredNode(
					$elm$core$Maybe$Just(l.eS)) : A2(
					join,
					_Utils_Tuple2(
						key,
						alteredNode($elm$core$Maybe$Nothing)),
					_Utils_Tuple2(l.eb, dict));
			default:
				var i = dict.a;
	...
	function (key, dict) {
		...
		while (true) {
			switch (dict.$) {
				...
				case 1:
					var l = dict.a;
					return _Utils_eq(l.eb, key) ? $elm$core$Maybe$Just(l.eS) : $elm$core$Maybe$Nothing;
				default:
					var i = dict.a;
...
var $elm_community$graph$Graph$fromNodesAndEdges = F2(
	function (nodes_, edges_) {
			...
			function (edge, rep) {
				var updateOutgoing = function (ctx) {
					return _Utils_update(
						ctx,
						{
							c6: A3($elm_community$intdict$IntDict$insert, edge.aX, edge.ft, ctx.c6)
						});
				};
				var updateIncoming = function (ctx) {
					return _Utils_update(
						ctx,
						{
							d5: A3($elm_community$intdict$IntDict$insert, edge.ar, edge.ft, ctx.d5)
						});
				};
				return A3(
					$elm_community$intdict$IntDict$update,
		...
		var addEdgeIfValid = F2(
			function (edge, rep) {
				return (A2($elm_community$intdict$IntDict$member, edge.ar, rep) && A2($elm_community$intdict$IntDict$member, edge.aX, rep)) ? A2(addEdge, edge, rep) : rep;
			});
		return A3($elm$core$List$foldl, addEdgeIfValid, nodeRep, edges_);
	});
var $author$project$GossipGraph$Relation$toEdge = function (rel) {
	return {ar: rel.ar, ft: rel, aX: rel.aX};
};
var $author$project$GossipGraph$Agent$toNode = function (agent) {
	return {b5: agent.b5, ft: agent};
};
...
var $author$project$GossipGraph$Relation$fromNodeContext = function (context) {
	return $elm_community$intdict$IntDict$values(context.c6);
};
	...
	function (context, acc) {
		...
		var relations = A2(
			...
			A2(
				$elm$core$List$map,
				function (r) {
					return _Utils_Tuple2(r.aX, r.ec);
				},
		...
		var updateOutgoingEdge = F2(
			function (upd, node) {
				return _Utils_update(
					node,
					{
						c6: A3($elm_community$intdict$IntDict$update, nodeId, upd, node.c6)
					});
			});
		var updateIncomingEdge = F2(
			function (upd, node) {
				return _Utils_update(
					node,
					{
						d5: A3($elm_community$intdict$IntDict$update, nodeId, upd, node.d5)
					});
			});
		var flippedFoldl = F3(
			function (f, dict, acc) {
...
var $elm_community$graph$Graph$emptyDiff = {d5: $elm_community$intdict$IntDict$empty, c6: $elm_community$intdict$IntDict$empty};
	...
	function (old, _new) {
		...
		if (_v0.a.$ === 1) {
			if (_v0.b.$ === 1) {
				...
				var ins = _v0.b.a;
				return {
					d5: A3(collect, $elm_community$graph$Graph$Insert, ins.c6, $elm_community$intdict$IntDict$empty),
					c6: A3(collect, $elm_community$graph$Graph$Insert, ins.d5, $elm_community$intdict$IntDict$empty)
				};
			}
		} else {
			if (_v0.b.$ === 1) {
				...
				var _v3 = _v0.b;
				return {
					d5: A3(collect, $elm_community$graph$Graph$Remove, rem.c6, $elm_community$intdict$IntDict$empty),
					c6: A3(collect, $elm_community$graph$Graph$Remove, rem.d5, $elm_community$intdict$IntDict$empty)
				};
			} else {
				var rem = _v0.a.a;
				var ins = _v0.b.a;
				return _Utils_eq(rem, ins) ? $elm_community$graph$Graph$emptyDiff : {
					d5: A3(
						...
						ins.c6,
						A3(collect, $elm_community$graph$Graph$Remove, rem.c6, $elm_community$intdict$IntDict$empty)),
					c6: A3(
						collect,
						$elm_community$graph$Graph$Insert,
						ins.d5,
						A3(collect, $elm_community$graph$Graph$Remove, rem.d5, $elm_community$intdict$IntDict$empty))
				};
			}
		}
	});
		...
		var wrappedUpdater = function (rep) {
			...
			var filterInvalidEdges = function (ctx) {
				return $elm_community$intdict$IntDict$filter(
					F2(
						function (id, _v0) {
							return _Utils_eq(id, ctx.en.b5) || A2($elm_community$intdict$IntDict$member, id, rep);
						}));
			};
			var cleanUpEdges = function (ctx) {
				return _Utils_update(
					ctx,
					{
						d5: A2(filterInvalidEdges, ctx, ctx.d5),
						c6: A2(filterInvalidEdges, ctx, ctx.c6)
					});
			};
			var _new = A2(
				$elm$core$Maybe$map,
				...
				while (true) {
					...
					if (!maybeContext.$) {
						...
						var $temp$acc1 = A2(f, ctx, acc1),
							$temp$graph1 = A2($elm_community$graph$Graph$remove, ctx.en.b5, graph1);
						acc1 = $temp$acc1;
						graph1 = $temp$graph1;
						continue go;
					} else {
...
var $author$project$Main$changeGossipGraph = F2(
	function (input, model) {
		...
		var callSequence = A2(
			$elm$core$Result$andThen,
			$author$project$CallSequence$Parser$parse(model.aE),
			agents);
...
var $author$project$GossipProtocol$BooleanFormula$And = 0;
var $author$project$GossipProtocol$Conditions$Constituents$HasCalled = 5;
var $author$project$GossipProtocol$BooleanFormula$Negated = 0;
var $author$project$GossipProtocol$Conditions$Constituents$WasCalledBy = 6;
var $author$project$GossipProtocol$BooleanFormula$Connective = function (a) {
	return {$: 0, a: a};
};
...
var $author$project$GossipProtocol$BooleanFormula$highestIndex = function (formula) {
	if (!formula.$) {
		return 0;
	} else {
		var index = formula.a;
		...
		return A2(
			...
			$elm$core$List$maximum(
				_List_fromArray(
					[
						index,
						$author$project$GossipProtocol$BooleanFormula$highestIndex(left),
						$author$project$GossipProtocol$BooleanFormula$highestIndex(right)
					])));
	}
};
var $author$project$GossipProtocol$BooleanFormula$append = F3(
	function (junction, el, formula) {
		var newIndex = $author$project$GossipProtocol$BooleanFormula$highestIndex(formula);
		if (!formula.$) {
			return A2($author$project$GossipProtocol$BooleanFormula$singleton, newIndex, el);
		} else {
			if ((!formula.c.$) && (!formula.d.$)) {
				var i = formula.a;
				var leaf = formula.b;
				var _v1 = formula.c;
				var _v2 = formula.d;
				return A4(
					$author$project$GossipProtocol$BooleanFormula$Node,
					newIndex + 1,
					$author$project$GossipProtocol$BooleanFormula$Connective(junction),
					A2($author$project$GossipProtocol$BooleanFormula$singleton, i, leaf),
					A2($author$project$GossipProtocol$BooleanFormula$singleton, newIndex + 2, el));
			} else {
				var i = formula.a;
				var label = formula.b;
				var left = formula.c;
				...
				return A4(
					...
					label,
					left,
					A3($author$project$GossipProtocol$BooleanFormula$append, junction, el, right));
			}
		}
	});
var $author$project$GossipProtocol$Conditions$Predefined$formulaCo = A3(
	$author$project$GossipProtocol$BooleanFormula$append,
	0,
	A2($author$project$GossipProtocol$BooleanFormula$Constituent, 0, 6),
	A2(
		$author$project$GossipProtocol$BooleanFormula$singleton,
		0,
		A2($author$project$GossipProtocol$BooleanFormula$Constituent, 0, 5)));
var $author$project$GossipProtocol$Conditions$Constituents$KnowsSecret = 7;
var $author$project$GossipProtocol$Conditions$Predefined$formulaLns = A2(
	$author$project$GossipProtocol$BooleanFormula$singleton,
	0,
	A2($author$project$GossipProtocol$BooleanFormula$Constituent, 0, 7));
var $author$project$GossipProtocol$Conditions$Constituents$Empty = 2;
var $author$project$GossipProtocol$Conditions$Constituents$LastFrom = 4;
var $author$project$GossipProtocol$BooleanFormula$Or = 1;
var $author$project$GossipProtocol$Conditions$Predefined$formulaSpi = A3(
	$author$project$GossipProtocol$BooleanFormula$append,
	1,
	A2($author$project$GossipProtocol$BooleanFormula$Constituent, 1, 4),
	A2(
		$author$project$GossipProtocol$BooleanFormula$singleton,
		0,
		A2($author$project$GossipProtocol$BooleanFormula$Constituent, 1, 2)));
var $author$project$GossipProtocol$Conditions$Constituents$LastTo = 3;
var $author$project$GossipProtocol$Conditions$Predefined$formulaTok = A3(
	$author$project$GossipProtocol$BooleanFormula$append,
	1,
	A2($author$project$GossipProtocol$BooleanFormula$Constituent, 1, 3),
	A2(
		$author$project$GossipProtocol$BooleanFormula$singleton,
		0,
		A2($author$project$GossipProtocol$BooleanFormula$Constituent, 1, 2)));
var $author$project$GossipProtocol$Conditions$Predefined$formulaWco = A2(
	$author$project$GossipProtocol$BooleanFormula$singleton,
	0,
	A2($author$project$GossipProtocol$BooleanFormula$Constituent, 1, 5));
var $author$project$GossipProtocol$Conditions$Predefined$formula = $elm$core$Dict$fromList(
	_List_fromArray(
		[
			_Utils_Tuple2('any', $author$project$GossipProtocol$Conditions$Predefined$formulaAny),
			_Utils_Tuple2('tok', $author$project$GossipProtocol$Conditions$Predefined$formulaTok),
			_Utils_Tuple2('spi', $author$project$GossipProtocol$Conditions$Predefined$formulaSpi),
			_Utils_Tuple2('co', $author$project$GossipProtocol$Conditions$Predefined$formulaCo),
			_Utils_Tuple2('wco', $author$project$GossipProtocol$Conditions$Predefined$formulaWco),
			_Utils_Tuple2('lns', $author$project$GossipProtocol$Conditions$Predefined$formulaLns)
		]));
...
var $author$project$Main$changeProtocol = F2(
	function (protocolName, model) {
		var formula = A2($elm$core$Dict$get, protocolName, $author$project$GossipProtocol$Conditions$Predefined$formula);
		var condition = A2($elm$core$Dict$get, protocolName, $author$project$GossipProtocol$Conditions$Predefined$condition);
		var _v0 = _Utils_Tuple2(condition, formula);
		if ((!_v0.a.$) && (!_v0.b.$)) {
			var c = _v0.a.a;
			var f = _v0.b.a;
			return _Utils_Tuple2(
			...
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						E: $author$project$GossipProtocol$Conditions$Predefined$formulaAny,
						u: $zwilias$elm_rosetree$Tree$singleton($author$project$GossipProtocol$GossipProtocol$Root),
						X: $author$project$GossipProtocol$Conditions$Predefined$any,
						I: 'any'
					}),
				$elm$core$Platform$Cmd$none);
		}
...
var $elm_community$intdict$IntDict$determineBranchRelation = F2(
	function (l, r) {
		...
		var mask = $elm_community$intdict$IntDict$highestBitSet(
			A2($elm_community$intdict$IntDict$mostSignificantBranchingBit, lp.a1, rp.a1));
		var modifiedRightPrefix = A3($elm_community$intdict$IntDict$combineBits, rp.an, ~lp.an, mask);
		var prefix = A2($elm_community$intdict$IntDict$lcp, lp.an, modifiedRightPrefix);
		var childEdge = F2(
			function (branchPrefix, c) {
				return A2($elm_community$intdict$IntDict$isBranchingBitSet, branchPrefix, c.i.an) ? 1 : 0;
			});
...
var $elm_community$intdict$IntDict$merge = F6(
	function (left, both, right, l, r, acc) {
		...
		while (true) {
				...
				switch (_v0.a.$) {
					...
					default:
						switch (_v0.b.$) {
							...
							case 1:
								var r2 = _v0.b.a;
								var _v4 = A2($elm_community$intdict$IntDict$get, r2.eb, l);
								if (_v4.$ === 1) {
									return A3(
										m,
										l,
										$elm_community$intdict$IntDict$Empty,
										A3(right, r2.eb, r2.eS, acc));
								} else {
									var v = _v4.a;
									return A3(
										m,
										A2($elm_community$intdict$IntDict$remove, r2.eb, l),
										$elm_community$intdict$IntDict$Empty,
										A4(both, r2.eb, v, r2.eS, acc));
								}
							default:
								var il = _v0.a.a;
								var ir = _v0.b.a;
			...
			var l2 = _v0.a.a;
			var _v3 = A2($elm_community$intdict$IntDict$get, l2.eb, r);
			if (_v3.$ === 1) {
				return A3(
					m,
					$elm_community$intdict$IntDict$Empty,
					r,
					A3(left, l2.eb, l2.eS, acc));
			} else {
				var v = _v3.a;
				return A3(
					m,
					$elm_community$intdict$IntDict$Empty,
					A2($elm_community$intdict$IntDict$remove, l2.eb, r),
					A4(both, l2.eb, l2.eS, v, acc));
			}
		}
		var _v2 = _v0.b;
						...
						_Utils_update(
							current,
							{
								c6: A6(
									...
									F4(
										function (k, c, n, acc) {
											return (c.ec === 1) ? A3($elm_community$intdict$IntDict$insert, k, c, acc) : ((n.ec === 1) ? A3(
												$elm_community$intdict$IntDict$insert,
												k,
												_Utils_update(
													n,
		...
		return $elm$core$Maybe$Just(
			{
				...
				D: A2(
					$elm$core$List$cons,
					{
						o: zipper.o,
						q: zipper.q,
						ft: $zwilias$elm_rosetree$Tree$label(zipper.r)
					},
					zipper.D),
				r: c
			});
		...
		return $elm$core$Maybe$Just(
			{
				...
				q: crumb.q,
				D: rest,
				r: A4($zwilias$elm_rosetree$Tree$Zipper$reconstruct, zipper.r, zipper.q, zipper.o, crumb.ft)
			});
	}
};
						...
						A2(
							...
							A2(
								...
								A2(
									$author$project$Utils$List$find,
									function (node) {
										return _Utils_eq(node.ft.b5, id);
									},
									agents)))));
			});
		var relations = A2(
		...
		if (!_v0.$) {
			...
			var highestIndex = A2(
				...
				$elm$core$List$maximum(
					A2(
						...
						$zwilias$elm_rosetree$Tree$flatten(model.u))));
			var newGraph = function (_v2) {
									...
									$author$project$GossipProtocol$GossipProtocol$Node(
										{
											dM: call,
											fq: index + 1,
											eL: A2($author$project$GossipGraph$Call$execute, state, call)
										}))),
							callHistory)),
					fq: index + 1,
					eL: A2($author$project$GossipGraph$Call$execute, state, call)
			...
			}(
				{
					aB: A2(
						$elm$core$Maybe$withDefault,
						$zwilias$elm_rosetree$Tree$Zipper$fromTree(model.u),
						A2(
							$zwilias$elm_rosetree$Tree$Zipper$findFromRoot,
							function (node) {
								if (node.$ === 1) {
									var index = node.a.fq;
									return _Utils_eq(index, model.ad);
								} else {
									return false;
								}
							},
			...
			return _Utils_Tuple2(
				_Utils_update(
					...
					{
						aq: $elm$core$Result$Ok(_List_Nil),
						aC: $author$project$GossipGraph$Parser$toCanonicalString(newGraph.eL),
						t: $elm$core$Result$Ok(newGraph.eL),
						u: $zwilias$elm_rosetree$Tree$Zipper$toTree(newGraph.aB),
						G: $elm_community$graph$Graph$isEmpty(model.G) ? A2($elm$core$Result$withDefault, $elm_community$graph$Graph$empty, model.t) : model.G,
						ad: newGraph.fq,
						aE: '',
						ae: $author$project$GossipGraph$Parser$toString(newGraph.eL),
						bH: $elm$core$Result$Ok(
							A3(
								$elm_community$graph$Graph$fold,
								F2(
									function (ctx, acc) {
...
var $author$project$Main$executeCallSequence = function (model) {
	var _v0 = _Utils_Tuple2(model.t, model.aq);
	if ((!_v0.a.$) && (!_v0.b.$)) {
		var graph = _v0.a.a;
		...
		while (true) {
			...
			if (_Utils_cmp(
				...
				return A2(
					$elm$core$Array$builderToArray,
					true,
					{B: nodeList, v: nodeListSize, x: jsArray});
			} else {
		...
		var calls = F2(
			function (context, acc) {
				...
				var relationPairs = A2(
					$elm$core$List$map,
					function (r) {
						return _Utils_Tuple2(r.ar, r.aX);
					},
					localRelations);
				return _Utils_ap(
					acc,
							...
							$author$project$GossipProtocol$GossipProtocol$Node(
								{
									dM: call,
									fq: index + ind,
									eL: A2($author$project$GossipGraph$Call$execute, graph, call)
								})),
						acc);
				}),
			state,
					...
					function (ind, child) {
						...
						if (_v0.$ === 1) {
							...
							return A6(
								...
								n.eL,
								condition,
								A2($elm$core$List$cons, n.dM, sequence),
								depth - 1,
								child);
						} else {
							return child;
...
var $author$project$Main$generateExecutionTree = function (model) {
	var initialGraph = $elm_community$graph$Graph$isEmpty(model.G) ? A2($elm$core$Result$withDefault, $elm_community$graph$Graph$empty, model.t) : model.G;
	return _Utils_Tuple2(
		_Utils_update(
			model,
			{
	...
	function (to, model) {
		var targetNode = (!to) ? $elm$core$Maybe$Just(
			$zwilias$elm_rosetree$Tree$Zipper$root(
				$zwilias$elm_rosetree$Tree$Zipper$fromTree(model.u))) : A2(
			$zwilias$elm_rosetree$Tree$Zipper$findFromRoot,
			function (zip) {
				if (zip.$ === 1) {
					var index = zip.a.fq;
				...
				case 1:
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								aC: $author$project$GossipGraph$Parser$toCanonicalString(n.eL),
								t: $elm$core$Result$Ok(n.eL),
								ad: to,
								ae: $author$project$GossipGraph$Parser$toString(n.eL)
							}),
						$elm$core$Platform$Cmd$none);
				case 0:
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								aC: $author$project$GossipGraph$Parser$toCanonicalString(model.G),
								t: $elm$core$Result$Ok(model.G),
								ad: to,
								ae: $author$project$GossipGraph$Parser$toString(model.G)
							}),
						$elm$core$Platform$Cmd$none);
				default:
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
...
var $author$project$GossipProtocol$BooleanFormula$pruneTreeAt = F2(
	function (index, tree) {
		var branchIndex = function (branch) {
			if (!branch.$) {
				return -1;
			} else {
				var i = branch.a;
		...
		if (!tree.$) {
			...
			var left = tree.c;
			var right = tree.d;
			var rightIndex = branchIndex(right);
			var leftIndex = branchIndex(left);
			return _Utils_eq(leftIndex, index) ? right : (_Utils_eq(rightIndex, index) ? left : A4(
				$author$project$GossipProtocol$BooleanFormula$Node,
				i,
				node,
				A2($author$project$GossipProtocol$BooleanFormula$pruneTreeAt, index, left),
				A2($author$project$GossipProtocol$BooleanFormula$pruneTreeAt, index, right)));
		}
	});
var $author$project$GossipProtocol$BooleanFormula$invertJunction = function (junction) {
	if (!junction) {
		return 1;
	} else {
		return 0;
...
var $author$project$GossipProtocol$BooleanFormula$toggleConnective = F2(
	function (formula, index) {
		if (!formula.$) {
			...
			if (_Utils_eq(i, index)) {
				if (!node.$) {
					...
					return $elm$core$Maybe$Just(
						A4(
							$author$project$GossipProtocol$BooleanFormula$Node,
							i,
							$author$project$GossipProtocol$BooleanFormula$Connective(
								$author$project$GossipProtocol$BooleanFormula$invertJunction(junction)),
							left,
							right));
				} else {
					return $elm$core$Maybe$Nothing;
				...
				var _v2 = A2($author$project$GossipProtocol$BooleanFormula$toggleConnective, left, index);
				if (_v2.$ === 1) {
					return A2(
						$elm$core$Maybe$andThen,
						function (t) {
							return $elm$core$Maybe$Just(
								A4($author$project$GossipProtocol$BooleanFormula$Node, i, node, left, t));
						},
						A2($author$project$GossipProtocol$BooleanFormula$toggleConnective, right, index));
				} else {
					var t = _v2.a;
					return $elm$core$Maybe$Just(
						A4($author$project$GossipProtocol$BooleanFormula$Node, i, node, t, right));
				}
			}
		}
	});
var $author$project$GossipProtocol$BooleanFormula$toggleNegation = F2(
	function (formula, index) {
		if (!formula.$) {
			return $elm$core$Maybe$Nothing;
		} else {
			...
			if (_Utils_eq(i, index)) {
					...
					if (!negation) {
						return $elm$core$Maybe$Just(
							A4(
								$author$project$GossipProtocol$BooleanFormula$Node,
								i,
								A2($author$project$GossipProtocol$BooleanFormula$Constituent, 1, value),
								left,
								right));
					} else {
						return $elm$core$Maybe$Just(
							A4(
								$author$project$GossipProtocol$BooleanFormula$Node,
								i,
								A2($author$project$GossipProtocol$BooleanFormula$Constituent, 0, value),
								left,
								right));
					}
				} else {
				...
				var _v3 = A2($author$project$GossipProtocol$BooleanFormula$toggleNegation, left, index);
				if (_v3.$ === 1) {
					return A2(
						$elm$core$Maybe$andThen,
						function (t) {
						...
						A2($author$project$GossipProtocol$BooleanFormula$toggleNegation, right, index));
				} else {
					var t = _v3.a;
					return $elm$core$Maybe$Just(
						A4($author$project$GossipProtocol$BooleanFormula$Node, i, node, t, right));
...
var $author$project$GossipProtocol$BooleanFormula$makeConnective = F4(
	function (id, junction, left, right) {
		return A4(
			$author$project$GossipProtocol$BooleanFormula$Node,
			id,
			$author$project$GossipProtocol$BooleanFormula$Connective(junction),
...
var $author$project$GossipProtocol$BooleanFormula$replaceTreeAt = F3(
	function (index, original, replacement) {
		if (!original.$) {
			return $elm$core$Maybe$Nothing;
		} else {
			var i = original.a;
			var node = original.b;
			var left = original.c;
			var right = original.d;
			if (_Utils_eq(i, index)) {
				if (replacement.$ === 1) {
					var replacementNode = replacement.b;
					return $elm$core$Maybe$Just(replacement);
				} else {
					return $elm$core$Maybe$Nothing;
				}
			} else {
				var _v2 = A3($author$project$GossipProtocol$BooleanFormula$replaceTreeAt, index, left, replacement);
				if (_v2.$ === 1) {
					return A2(
						$elm$core$Maybe$andThen,
						function (t) {
						...
						A3($author$project$GossipProtocol$BooleanFormula$replaceTreeAt, index, right, replacement));
				} else {
					var t = _v2.a;
					return $elm$core$Maybe$Just(
						A4($author$project$GossipProtocol$BooleanFormula$Node, i, node, t, right));
...
var $author$project$GossipProtocol$BooleanFormula$subTreeAt = F2(
		...
		while (true) {
			if (!formula.$) {
				...
				if (_Utils_eq(i, index)) {
					...
					var _v1 = A2($author$project$GossipProtocol$BooleanFormula$subTreeAt, index, left);
					if (_v1.$ === 1) {
...
var $author$project$Main$updateFormula = F4(
	function (dragId, dropId, _v0, formula) {
		var droppedOn = A2($author$project$GossipProtocol$BooleanFormula$subTreeAt, dropId, formula);
		var dragged = A2($author$project$GossipProtocol$BooleanFormula$subTreeAt, dragId, formula);
		if (!_Utils_eq(dragId, dropId)) {
			var _v1 = _Utils_Tuple2(dragged, droppedOn);
			if ((!_v1.a.$) && (!_v1.b.$)) {
				var draggedElement = _v1.a.a;
				var droppedElement = _v1.b.a;
				return function (newFormula) {
					return A2(
						$elm$core$Maybe$withDefault,
						formula,
						A3(
							$author$project$GossipProtocol$BooleanFormula$replaceTreeAt,
							dropId,
							newFormula,
							A4(
								$author$project$GossipProtocol$BooleanFormula$makeConnective,
								$author$project$GossipProtocol$BooleanFormula$highestIndex(formula) + 1,
								1,
								droppedElement,
								draggedElement)));
				}(
					A2($author$project$GossipProtocol$BooleanFormula$pruneTreeAt, dragId, formula));
			} else {
				return formula;
			}
		} else {
...
var $author$project$Main$updateProtocol = F2(
	function (msg, model) {
		switch (msg.$) {
			case 0:
				var message = msg.a;
				var _v1 = A2($norpan$elm_html5_drag_drop$Html5$DragDrop$update, message, model.b2);
				var newModel = _v1.a;
				var result = _v1.b;
				var newFormula = function () {
					if (!result.$) {
						var _v3 = result.a;
						var dragId = _v3.a;
						var dropId = _v3.b;
						var position = _v3.c;
						return A4($author$project$Main$updateFormula, dragId, dropId, position, model.E);
					} else {
						return model.E;
					}
				}();
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							b2: newModel,
							E: newFormula,
							X: $author$project$GossipProtocol$GossipProtocol$evaluateFormulaAsProtocolCondition(newFormula),
							I: 'custom'
						}),
					A2(
						$elm$core$Maybe$withDefault,
						...
						A2(
							...
							$norpan$elm_html5_drag_drop$Html5$DragDrop$getDragstartEvent(message))));
			case 1:
				var index = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
			...
			case 3:
				var index = msg.a;
				var _v4 = A2($author$project$GossipProtocol$BooleanFormula$toggleConnective, model.E, index);
				if (!_v4.$) {
					var newFormula = _v4.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
			...
			case 5:
				var index = msg.a;
				var _v5 = A2($author$project$GossipProtocol$BooleanFormula$toggleNegation, model.E, index);
				if (!_v5.$) {
					var newFormula = _v5.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
			...
			case 4:
				var id = msg.a;
				var newFormula = A2($author$project$GossipProtocol$BooleanFormula$pruneTreeAt, id, model.E);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
					...
					$elm$core$Platform$Cmd$none);
			case 7:
				var constituent = msg.a;
				var newFormula = A3($author$project$GossipProtocol$BooleanFormula$append, 1, constituent, model.E);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
			...
			case 11:
				return _Utils_Tuple2(
					_Utils_update(
						...
						{
							u: $zwilias$elm_rosetree$Tree$singleton($author$project$GossipProtocol$GossipProtocol$Root),
							G: A2($elm$core$Result$withDefault, $elm_community$graph$Graph$empty, model.t),
							ad: 0
						}),
					$elm$core$Platform$Cmd$none);
			default:
				var message = msg.a;
				return A2($author$project$Main$updateProtocol, message, model);
		}
	});
...
var $lattyware$elm_fontawesome$FontAwesome$Icon$Icon = F5(
	function (prefix, name, width, height, paths) {
		return {d0: height, c0: name, fF: paths, i: prefix, eX: width};
	});
...
var $lattyware$elm_fontawesome$FontAwesome$Icon$present = function (icon) {
	return {bY: _List_Nil, d4: icon, b5: $elm$core$Maybe$Nothing, bF: $elm$core$Maybe$Nothing, dm: 'img', ch: $elm$core$Maybe$Nothing, ck: _List_Nil};
};
	...
	function (transform, combined) {
		switch (transform.$) {
			...
			case 1:
				...
				return _Utils_update(
					combined,
					{aa: combined.aa + x, ab: combined.ab + y});
			case 2:
...
var $lattyware$elm_fontawesome$FontAwesome$Transforms$Internal$meaninglessTransform = {fk: false, fl: false, fK: 0, dp: $lattyware$elm_fontawesome$FontAwesome$Transforms$Internal$baseSize, aa: 0, ab: 0};
...
var $lattyware$elm_fontawesome$FontAwesome$Transforms$Internal$transformForSvg = F3(
	function (containerWidth, iconWidth, transform) {
		...
		var innerTranslate = 'translate(' + ($elm$core$String$fromFloat(transform.aa * 32) + (',' + ($elm$core$String$fromFloat(transform.ab * 32) + ') ')));
		var innerRotate = 'rotate(' + ($elm$core$String$fromFloat(transform.fK) + ' 0 0)');
		var flipY = transform.fl ? (-1) : 1;
		var scaleY = (transform.dp / $lattyware$elm_fontawesome$FontAwesome$Transforms$Internal$baseSize) * flipY;
		var flipX = transform.fk ? (-1) : 1;
		var scaleX = (transform.dp / $lattyware$elm_fontawesome$FontAwesome$Transforms$Internal$baseSize) * flipX;
		var innerScale = 'scale(' + ($elm$core$String$fromFloat(scaleX) + (', ' + ($elm$core$String$fromFloat(scaleY) + ') ')));
		return {
			d6: $elm$svg$Svg$Attributes$transform(
				_Utils_ap(
					innerTranslate,
					_Utils_ap(innerScale, innerRotate))),
			bF: $elm$svg$Svg$Attributes$transform(outer),
			es: $elm$svg$Svg$Attributes$transform(path)
		};
	});
...
var $lattyware$elm_fontawesome$FontAwesome$Icon$internalView = function (_v0) {
	...
	var transforms = _v0.ck;
	var role = _v0.dm;
	var id = _v0.b5;
	var title = _v0.ch;
	var outer = _v0.bF;
	var alwaysId = A2($elm$core$Maybe$withDefault, icon.c0, id);
	...
	var _v1 = A2(
		$elm$core$Maybe$withDefault,
		_Utils_Tuple2(icon.eX, icon.d0),
		A2(
			$elm$core$Maybe$map,
			function (o) {
				return _Utils_Tuple2(o.eX, o.d0);
			},
			outer));
	var width = _v1.a;
	var height = _v1.b;
	...
	var svgTransform = A2(
		$elm$core$Maybe$map,
		A2($lattyware$elm_fontawesome$FontAwesome$Transforms$Internal$transformForSvg, width, icon.eX),
		$lattyware$elm_fontawesome$FontAwesome$Transforms$Internal$meaningfulTransform(transforms));
	var contents = function () {
		var resolvedSvgTransform = A2(
			$elm$core$Maybe$withDefault,
			A3($lattyware$elm_fontawesome$FontAwesome$Transforms$Internal$transformForSvg, width, icon.eX, $lattyware$elm_fontawesome$FontAwesome$Transforms$Internal$meaninglessTransform),
			svgTransform);
		return A2(
			$elm$core$Maybe$withDefault,
			_List_fromArray(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					'Information about ' + $elm$core$String$toLower(title_)),
					$elm$html$Html$Events$onClick(
					A2($author$project$Main$ShowModal, title_, content))
				]),
			_List_fromArray(
				[
...
var $author$project$GossipGraph$Call$render = F2(
	function (agents, call) {
		var _v0 = _Utils_Tuple2(
			A2($author$project$GossipGraph$Agent$fromId, agents, call.ar),
			A2($author$project$GossipGraph$Agent$fromId, agents, call.aX));
		if ((!_v0.a.$) && (!_v0.b.$)) {
			var from = _v0.a.a;
			var to = _v0.b.a;
			return A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						$elm$core$String$fromChar(from.c0) + (' 📞 ' + $elm$core$String$fromChar(to.c0)))
					]));
		} else {
			return A2(
				$elm$html$Html$div,
...
var $author$project$Main$callSequenceView = function (model) {
	var permitted = function () {
		...
		if ((!_v0.a.$) && (!_v0.b.$)) {
			var graph = _v0.a.a;
			var sequence = _v0.b.a;
			return A3($author$project$GossipProtocol$GossipProtocol$sequencePermittedOn, model.X, graph, sequence);
		} else {
			return false;
		}
	}();
	var empty = $elm$core$String$isEmpty(model.aE);
	return A2(
		...
		_List_fromArray(
			[
					...
					[
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Attributes$class(
								(permitted && (!empty)) ? 'permitted' : (empty ? '' : 'not-permitted')),
								...
								A2(
									...
									A2(
										...
										A2(
											$elm$core$Maybe$withDefault,
											'?',
											A2($elm$core$Dict$get, model.I, $author$project$GossipProtocol$Conditions$Predefined$name)),
										permitted)))
							]),
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Attributes$disabled((!permitted) || empty),
								$elm$html$Html$Attributes$title(
								empty ? 'Please fill in a call sequence to execute' : (permitted ? 'Execute this call sequence on the gossip graph' : 'The call sequence must be permitted before it can be executed'))
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Execute')
				...
				A2($author$project$CallSequence$Renderer$render, model.aq, model.aO))
			]));
};
...
var $author$project$GossipGraph$Relation$isOfKind = F2(
	function (relation, kind) {
		return _Utils_eq(relation.ec, kind) || ((relation.ec === 1) && (!kind));
	});
	...
	function (l, r) {
		...
		while (true) {
			...
			while (true) {
					...
					switch (_v0.a.$) {
						...
						default:
							switch (_v0.b.$) {
								...
								case 1:
									var lr = _v0.b.a;
									var _v3 = A2($elm_community$intdict$IntDict$get, lr.eb, l);
									if (!_v3.$) {
										var v = _v3.a;
										return A2($elm_community$intdict$IntDict$leaf, lr.eb, v);
									} else {
										return $elm_community$intdict$IntDict$Empty;
									}
								default:
				...
				var ll = _v0.a.a;
				return A2($elm_community$intdict$IntDict$member, ll.eb, r) ? l : $elm_community$intdict$IntDict$Empty;
			}
			var _v2 = _v0.b;
			return $elm_community$intdict$IntDict$Empty;
		}
	...
	function (ordering, graph) {
		...
		var check = F2(
			function (id, _v2) {
				...
				var backEdges = A2($elm_community$intdict$IntDict$intersect, ctx.c6, backSetWithId);
...
var $elm_community$graph$Graph$alongOutgoingEdges = function (ctx) {
	return $elm_community$intdict$IntDict$keys(ctx.c6);
};
						...
						A2(
							...
							$elm_community$intdict$IntDict$toList(
								A2(
									...
									F2(
										function (_v5, r) {
											return A2($author$project$GossipGraph$Relation$isOfKind, r, kind) && (!_Utils_eq(r.aX, r.ar));
										}),
									ctx.c6)))));
			});
		var merger = F4(
	...
	[
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$type_('button'),
				$elm$html$Html$Attributes$class('icon'),
				$elm$html$Html$Attributes$title('Load the numbers example'),
		...
		_List_fromArray(
			[
				$elm$html$Html$text('In this example, three agents only know each others\' phone numbers.')
			])),
		A2(
		$elm$html$Html$h4,
		_List_Nil,
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$type_('button'),
				$elm$html$Html$Attributes$class('icon'),
				$elm$html$Html$Attributes$title('Load the secrets example'),
				A2($elm$html$Html$Attributes$style, 'float', 'right'),
				$elm$html$Html$Events$onClick(
				$author$project$Main$InsertExampleGraph('ABC ABC ABC'))
			]),
		...
		_List_fromArray(
			[
				$elm$html$Html$text('In this example, three agents know each others\' secrets already.')
			])),
		A2(
		$elm$html$Html$h4,
		_List_Nil,
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$type_('button'),
				$elm$html$Html$Attributes$class('icon'),
				$elm$html$Html$Attributes$title('Load the complex example'),
				A2($elm$html$Html$Attributes$style, 'float', 'right'),
				$elm$html$Html$Events$onClick(
...
var $author$project$Main$gossipGraphHelpView = _List_fromArray(
	[
		...
		_List_fromArray(
			[
				$elm$html$Html$text('This notation is based on the notation in the appendix of the paper '),
				A2(
				$elm$html$Html$a,
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Strengthening Gossip Protocols using Protocol-Dependent Knowledge')
					])),
				$elm$html$Html$text(' by Van Ditmarsch et al. (2019).')
			]))
	]);
...
var $gampleman$elm_visualization$Force$entity = F2(
	function (index, a) {
		...
		return {
			...
			ao: 0.0,
			ap: 0.0,
			aa: radius * $elm$core$Basics$cos(angle),
			ab: radius * $elm$core$Basics$sin(angle)
		};
	});
var $author$project$GossipGraph$Renderer$agentToEntity = function (agent) {
	return A2($gampleman$elm_visualization$Force$entity, agent.b5, agent);
};
...
var $author$project$GossipGraph$Renderer$arrowHeads = function (settings) {
	var width = settings.bq;
	var height = settings.bq;
	var yMid = height / 2;
	return _List_fromArray(
		[
			A2(
...
var $ianmackenzie$elm_geometry$Vector2d$from = F2(
	function (_v0, _v1) {
		var p1 = _v0;
		var p2 = _v1;
		return {aa: p2.aa - p1.aa, ab: p2.ab - p1.ab};
	});
...
var $ianmackenzie$elm_geometry$Vector2d$length = function (_v0) {
	...
	var largestComponent = A2(
		$elm$core$Basics$max,
		$elm$core$Basics$abs(v.aa),
		$elm$core$Basics$abs(v.ab));
	if (!largestComponent) {
		return $ianmackenzie$elm_units$Quantity$zero;
	} else {
		var scaledY = v.ab / largestComponent;
		var scaledX = v.aa / largestComponent;
		var scaledLength = $elm$core$Basics$sqrt((scaledX * scaledX) + (scaledY * scaledY));
		return scaledLength * largestComponent;
	}
};
...
var $ianmackenzie$elm_geometry$Vector2d$zero = {aa: 0, ab: 0};
var $gampleman$elm_visualization$Force$ManyBody$applyForce = F4(
	function (alpha, theta, qtree, vertex) {
		var isFarAway = function (treePart) {
			var distance = A2($ianmackenzie$elm_geometry$Point2d$distanceFrom, vertex.fG, treePart.dI.fG);
			var _v2 = $ianmackenzie$elm_geometry$BoundingBox2d$dimensions(treePart.e2);
			var width = _v2.a;
			return _Utils_cmp(
		...
		var useAggregate = function (treePart) {
			return A2(calculateVelocity, vertex, treePart.dI);
		};
		switch (qtree.$) {
			case 0:
				...
				if (isFarAway(leaf)) {
					...
					var applyForceFromPoint = F2(
						function (point, accum) {
							return _Utils_eq(point.eb, vertex.eb) ? accum : A2(
...
var $ianmackenzie$elm_geometry$Point2d$coordinates = function (_v0) {
	var p = _v0;
	return _Utils_Tuple2(p.aa, p.ab);
};
...
var $gampleman$elm_visualization$Force$ManyBody$config = {
	e6: $gampleman$elm_visualization$Force$ManyBody$constructSuperPoint,
	e7: $gampleman$elm_visualization$Force$ManyBody$constructSuperPoint,
	f_: function ($) {
		return $.fG;
	}
};
...
var $ianmackenzie$elm_geometry$BoundingBox2d$fromExtrema = function (given) {
	return (A2($ianmackenzie$elm_units$Quantity$lessThanOrEqualTo, given.ba, given.bc) && A2($ianmackenzie$elm_units$Quantity$lessThanOrEqualTo, given.bb, given.bd)) ? given : {
		ba: A2($ianmackenzie$elm_units$Quantity$max, given.bc, given.ba),
		bb: A2($ianmackenzie$elm_units$Quantity$max, given.bd, given.bb),
		bc: A2($ianmackenzie$elm_units$Quantity$min, given.bc, given.ba),
		bd: A2($ianmackenzie$elm_units$Quantity$min, given.bd, given.bb)
	};
};
...
var $ianmackenzie$elm_geometry$BoundingBox2d$midX = function (_v0) {
	var boundingBox = _v0;
	return A3($ianmackenzie$elm_units$Quantity$interpolateFrom, boundingBox.bc, boundingBox.ba, 0.5);
};
var $ianmackenzie$elm_geometry$BoundingBox2d$midY = function (_v0) {
	var boundingBox = _v0;
	return A3($ianmackenzie$elm_units$Quantity$interpolateFrom, boundingBox.bd, boundingBox.bb, 0.5);
};
...
var $ianmackenzie$elm_geometry$BoundingBox2d$singleton = function (point) {
	return {
		ba: $ianmackenzie$elm_geometry$Point2d$xCoordinate(point),
		bb: $ianmackenzie$elm_geometry$Point2d$yCoordinate(point),
		bc: $ianmackenzie$elm_geometry$Point2d$xCoordinate(point),
		bd: $ianmackenzie$elm_geometry$Point2d$yCoordinate(point)
	};
};
var $gampleman$elm_visualization$Force$QuadTree$singleton = F2(
	function (toPoint, vertex) {
		return $gampleman$elm_visualization$Force$QuadTree$Leaf(
			{
				dI: 0,
				e2: $ianmackenzie$elm_geometry$BoundingBox2d$singleton(
					toPoint(vertex)),
				e5: _Utils_Tuple2(vertex, _List_Nil)
			});
	});
var $ianmackenzie$elm_geometry$BoundingBox2d$union = F2(
	function (firstBox, secondBox) {
		...
		return {
			ba: A2($ianmackenzie$elm_units$Quantity$max, b1.ba, b2.ba),
			bb: A2($ianmackenzie$elm_units$Quantity$max, b1.bb, b2.bb),
			bc: A2($ianmackenzie$elm_units$Quantity$min, b1.bc, b2.bc),
			bd: A2($ianmackenzie$elm_units$Quantity$min, b1.bd, b2.bd)
		};
	});
	...
	function (toPoint, vertex, qtree) {
		switch (qtree.$) {
					...
					var initial = $gampleman$elm_visualization$Force$QuadTree$Node(
						{
							...
							e2: A2(
								...
								$ianmackenzie$elm_geometry$BoundingBox2d$singleton(
									toPoint(vertex))),
							fx: $gampleman$elm_visualization$Force$QuadTree$Empty,
			...
			default:
				...
				if (A2($ianmackenzie$elm_geometry$BoundingBox2d$contains, point, node.e2)) {
					var _v2 = A2($gampleman$elm_visualization$Force$QuadTree$quadrant, node.e2, point);
					switch (_v2) {
						case 0:
							return $gampleman$elm_visualization$Force$QuadTree$Node(
								{
									dI: node.dI,
									e2: node.e2,
									fx: A3($gampleman$elm_visualization$Force$QuadTree$insertBy, toPoint, vertex, node.fx),
									fz: node.fz,
									fO: node.fO,
									fU: node.fU
								});
					...
					var _v3 = $ianmackenzie$elm_geometry$BoundingBox2d$extrema(node.e2);
					var minX = _v3.bc;
					var minY = _v3.bd;
					var maxX = _v3.ba;
					var maxY = _v3.bb;
					var _v4 = $ianmackenzie$elm_geometry$BoundingBox2d$dimensions(node.e2);
					var width = _v4.a;
					var height = _v4.b;
					var _v5 = A2($gampleman$elm_visualization$Force$QuadTree$quadrant, node.e2, point);
					switch (_v5) {
						case 0:
							return $gampleman$elm_visualization$Force$QuadTree$Node(
								{
									dI: 0,
									e2: $ianmackenzie$elm_geometry$BoundingBox2d$fromExtrema(
										{
											ba: A2($ianmackenzie$elm_units_prefixed$Units$Quantity$plus, width, maxX),
											bb: A2($ianmackenzie$elm_units_prefixed$Units$Quantity$plus, height, maxY),
											bc: minX,
											bd: minY
										}),
									fx: A2($gampleman$elm_visualization$Force$QuadTree$singleton, toPoint, vertex),
									fz: $gampleman$elm_visualization$Force$QuadTree$Empty,
									fO: $gampleman$elm_visualization$Force$QuadTree$Empty,
									fU: qtree
								});
									...
									e2: $ianmackenzie$elm_geometry$BoundingBox2d$fromExtrema(
										{
											...
											bb: maxY,
											bc: minX,
											bd: A2($ianmackenzie$elm_units_prefixed$Units$Quantity$minus, height, minY)
										}),
									fx: $gampleman$elm_visualization$Force$QuadTree$Empty,
									fz: qtree,
									...
									e2: $ianmackenzie$elm_geometry$BoundingBox2d$fromExtrema(
										{
											ba: maxX,
											bb: A2($ianmackenzie$elm_units_prefixed$Units$Quantity$plus, height, maxY),
											bc: A2($ianmackenzie$elm_units_prefixed$Units$Quantity$minus, width, minX),
											bd: minY
										}),
									fx: $gampleman$elm_visualization$Force$QuadTree$Empty,
...
var $gampleman$elm_visualization$Force$QuadTree$performAggregate = F2(
	function (config, vanillaQuadTree) {
		var combineAggregates = config.e6;
		var combineVertices = config.e7;
		switch (vanillaQuadTree.$) {
			...
			case 1:
				...
				return $gampleman$elm_visualization$Force$QuadTree$Leaf(
					{
						dI: A2(combineVertices, first, rest),
						e2: leaf.e2,
						e5: _Utils_Tuple2(first, rest)
					});
			default:
				...
				var newNw = A2($gampleman$elm_visualization$Force$QuadTree$performAggregate, config, node.fz);
				var newNe = A2($gampleman$elm_visualization$Force$QuadTree$performAggregate, config, node.fx);
				var subresults = A2(
		...
		var updater = F2(
			function (newVertex, maybePoint) {
				if (maybePoint.$ === 1) {
					...
					var dv = $ianmackenzie$elm_geometry$Vector2d$toPixels(newVertex.bW);
					return $elm$core$Maybe$Just(
						_Utils_update(
							point,
							{ao: point.ao + dv.aa, ap: point.ap + dv.ab}));
				}
			});
				...
				var _v1 = A3(
					...
					F3(
						function (_v2, ent, _v3) {
							var sx0 = _v3.a;
							var sy0 = _v3.b;
							return _Utils_Tuple2(sx0 + ent.aa, sy0 + ent.ab);
						}),
					_Utils_Tuple2(0, 0),
					entities);
				var sumx = _v1.a;
							...
							F2(
								function (_v5, ents) {
									...
									if ((!_v6.a.$) && (!_v6.b.$)) {
										...
										var y = ((targetNode.ab + targetNode.ap) - sourceNode.ab) - sourceNode.ap;
										var x = ((targetNode.aa + targetNode.ao) - sourceNode.aa) - sourceNode.ao;
										...
										return A3(
											...
											$elm$core$Maybe$map(
												function (tn) {
													return _Utils_update(
														tn,
														{ao: tn.ao + ((x * l) * (1 - bias)), ap: tn.ap + ((y * l) * (1 - bias))});
												}),
											A3(
												$elm$core$Dict$update,
												target,
												$elm$core$Maybe$map(
													function (sn) {
														return _Utils_update(
															sn,
															{ao: sn.ao - ((x * l) * bias), ap: sn.ap - ((y * l) * bias)});
													}),
												ents));
									} else {
										var otherwise = _v6;
...
var $gampleman$elm_visualization$Force$tick = F2(
	function (_v0, nodes) {
		...
		var updateEntity = function (ent) {
			return _Utils_update(
				ent,
				{ao: ent.ao * state.bX, ap: ent.ap * state.bX, aa: ent.aa + (ent.ao * state.bX), ab: ent.ab + (ent.ap * state.bX)});
		};
		var dictNodes = A3(
			$elm$core$List$foldl,
			function (node) {
				return A2($elm$core$Dict$insert, node.b5, node);
			},
			$elm$core$Dict$empty,
			nodes);
		var alpha = state.a0 + ((state.dK - state.a0) * state.cm);
		var newNodes = A3(
			$elm$core$List$foldl,
		...
		return A2(
			...
			A2(
				...
				function (_v0) {
					...
					var strength = _v0.fS;
					return {
						cq: count(source) / (count(source) + count(target)),
						fc: distance,
						fQ: source,
						fS: A2(
							$elm$core$Maybe$withDefault,
...
var $author$project$GossipGraph$Renderer$radialOffsetValue = F4(
	function (source, target, xoff, yoff) {
		var _v0 = _Utils_Tuple2(
			_Utils_cmp(source.aa, target.aa) > 0,
			_Utils_cmp(source.ab, target.ab) > 0);
		if (_v0.a) {
			if (_v0.b) {
				return _Utils_Tuple2(source.aa - xoff, source.ab - yoff);
			} else {
				return _Utils_Tuple2(source.aa - xoff, source.ab + yoff);
			}
		} else {
...
var $author$project$GossipGraph$Renderer$radialOffset = F4(
	function (source, target, sourceOffset, targetOffset) {
		var dy = $elm$core$Basics$abs(source.ab - target.ab);
		var dx = $elm$core$Basics$abs(source.aa - target.aa);
...
var $author$project$GossipGraph$Renderer$renderEdgeDirected = F4(
	function (settings, extraAttributes, source, target) {
		var r2 = settings.aT + (2 * settings.bq);
		var r1 = settings.aT;
			...
			_Utils_ap(
				_List_fromArray(
					[
						...
						$elm_community$typed_svg$TypedSvg$Types$px(settings.b3)),
...
var $author$project$GossipGraph$Renderer$angularOffset = F3(
	function (_v0, offset, node) {
		...
		var newX = _v2.a;
		var newY = _v2.b;
		return _Utils_Tuple2(node.aa + newX, node.ab + newY);
	});
...
var $author$project$GossipGraph$Renderer$renderEdge = F3(
	function (graph, settings, edge) {
		...
		var source = retrieveEntity(
			A2($elm_community$graph$Graph$get, edge.ar, graph));
		var target = retrieveEntity(
			A2($elm_community$graph$Graph$get, edge.aX, graph));
		var dashed = (!edge.ft.ec) ? _List_fromArray(
			[
				$elm_community$typed_svg$TypedSvg$Attributes$strokeDasharray(
				$elm$core$String$fromFloat(settings.b3 * 2))
			]) : _List_Nil;
		return A2(
			$elm$core$List$any,
			function (e) {
				return _Utils_eq(edge.ar, e.aX) && _Utils_eq(edge.aX, e.ar);
			},
				...
				[
					...
					_List_fromArray(
						[
							...
							$elm_community$typed_svg$TypedSvg$Types$px(settings.aT)),
							...
							$elm_community$typed_svg$TypedSvg$Types$px(node.ft.aa)),
							$elm_community$typed_svg$TypedSvg$Attributes$cy(
							$elm_community$typed_svg$TypedSvg$Types$px(node.ft.ab))
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									...
									$elm$core$String$fromChar(node.ft.eS.c0))
								]))
						])),
					A2(
					...
					_List_fromArray(
						[
							...
							$elm_community$typed_svg$TypedSvg$Types$px(settings.aT / 3))
						]),
					_List_fromArray(
						[
							$elm_community$typed_svg$TypedSvg$Core$text(
...
var $gampleman$elm_visualization$Force$simulation = function (forces) {
	return {
		a0: 1.0,
		cm: 1 - A2($elm$core$Basics$pow, 0.001, 1 / 300),
		dK: 0.0,
		d_: forces,
		cZ: 0.001,
		bX: 0.6
	...
	function (graph, settings) {
		...
		var forces = _List_fromArray(
			[
				...
				A2($gampleman$elm_visualization$Force$center, settings.ct / 2, settings.cs / 2)
			]);
		...
		return A2(
			...
			_List_fromArray(
				[
					A4($elm_community$typed_svg$TypedSvg$Attributes$viewBox, 0, 0, settings.ct, settings.cs),
					A2(
...
var $author$project$GossipProtocol$GossipProtocol$isSunGraph = function (graph) {
	var isTerminal = function (context) {
		return $elm_community$intdict$IntDict$isEmpty(
			A2($elm_community$intdict$IntDict$remove, context.en.b5, context.c6));
	};
	var prune = F2(
		function (context, prunedGraph) {
			return isTerminal(context) ? A2($elm_community$graph$Graph$remove, context.en.b5, prunedGraph) : prunedGraph;
		});
	return A2(
		$author$project$GossipProtocol$GossipProtocol$isStronglyConnected,
		0,
		A3($elm_community$graph$Graph$fold, prune, graph, graph));
};
...
var $author$project$Main$gossipGraphView = function (model) {
	var graphIsValid = function () {
		var _v1 = _Utils_Tuple2(
			$elm$core$String$isEmpty(model.ae),
			model.t);
		if ((!_v1.a) && (!_v1.b.$)) {
			return true;
		} else {
	...
	return A2(
		...
		_List_fromArray(
			[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$type_('button'),
										$elm$html$Html$Attributes$title('Select one of several predefined gossip graphs'),
										$elm$html$Html$Events$onClick(
				...
				$elm$core$String$isEmpty(model.ae) ? A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						A2($author$project$GossipGraph$Renderer$render, model.t, model.cD),
						function () {
						var _v0 = model.t;
						if (!_v0.$) {
							return A2(
...
var $lattyware$elm_fontawesome$FontAwesome$Brands$github = A5(
	$lattyware$elm_fontawesome$FontAwesome$Icon$Icon,
	'fab',
	'github',
	496,
...
var $author$project$Main$headerHelpView = function () {
	var newTabLink = F3(
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$title('Go to ' + (name + ' (opens in a new tab)')),
						$elm$html$Html$Attributes$target('_blank')
					]),
				_List_fromArray(
					[content]));
		});
	var packageUrl = function (name) {
		var url = 'https://package.elm-lang.org/packages/' + (name + '/latest/');
		var title = 'the ' + (name + ' package on the Elm package site');
		var content = A2(
			$elm$html$Html$code,
			_List_Nil,
			_List_fromArray(
		...
		return A3(newTabLink, content, title, url);
	};
	return _List_fromArray(
		[
			A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$text('ElmGossip is a web tool for exploring and analysing dynamic gossip.'),
					$elm$html$Html$text(' This application is developed by '),
					A3(
					newTabLink,
					$elm$html$Html$text('Ramon Meffert'),
					'Ramon\'s personal website',
					'https://r3n.nl'),
					$elm$html$Html$text(' and started as part of his '),
					A3(
					newTabLink,
					$elm$html$Html$text('bachelor\'s research project'),
					'the thesis on the project',
					'https://fse.studenttheses.ub.rug.nl/23961/'),
					$elm$html$Html$text(' at the University of Groningen under supervision of Dr. '),
					A3(
					newTabLink,
					$elm$html$Html$text('Malvin Gattinger'),
					'Malvin\'s personal website',
					'https://malv.in'),
					$elm$html$Html$text('.')
				])),
			A2(
				...
				[
					...
					_List_fromArray(
						[
							...
							'the Elm website',
							'https://elm-lang.org'),
							$elm$html$Html$text(', a functional web language, along with (among others) the following packages:'),
							A2(
							$elm$html$Html$ul,
							_List_Nil,
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											...
											$elm$html$Html$text(' for internal graph representation')
										])),
									A2(
									$elm$html$Html$li,
									_List_Nil,
									_List_fromArray(
										[
											...
											$elm$html$Html$text(' for rendering the graphs')
										])),
									A2(
									$elm$html$Html$li,
									_List_Nil,
									...
									_List_fromArray(
										[
											...
											$elm$html$Html$text(' for the drag-and-drop functionality of the protocol builder')
										])),
									A2(
									$elm$html$Html$li,
									_List_Nil,
									_List_fromArray(
										[
											...
											$elm$html$Html$text(' for the call history/execution tree')
										]))
								]))
						])),
					A2(
			...
			_List_fromArray(
				[
					...
					'the GitHub repository for ElmGossip',
		...
		[
				...
				[
					...
					_List_fromArray(
						[
							...
							$elm$html$Html$Attributes$src('logo-small.svg'),
							$elm$html$Html$Attributes$title('ElmGossip Logo')
						]),
					_List_Nil),
					A2(
					$elm$html$Html$div,
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('transparent icon button'),
							$elm$html$Html$Attributes$href('https://github.com/ramonmeffert/elm-gossip'),
							$elm$html$Html$Attributes$title('Source code (opens in a new tab)'),
							$elm$html$Html$Attributes$target('_blank')
						]),
					_List_fromArray(
						[
							$lattyware$elm_fontawesome$FontAwesome$Icon$viewIcon($lattyware$elm_fontawesome$FontAwesome$Brands$github),
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('transparent help icon'),
							$elm$html$Html$Attributes$title('About this tool'),
							$elm$html$Html$Events$onClick(
							A2($author$project$Main$ShowModal, 'ElmGossip', $author$project$Main$headerHelpView))
						]),
					_List_fromArray(
						[
							$lattyware$elm_fontawesome$FontAwesome$Icon$viewIcon($lattyware$elm_fontawesome$FontAwesome$Solid$infoCircle),
							$elm$html$Html$text('About')
						]))
				]))
		]));
var $author$project$Main$ClearExecutionTree = {$: 11};
...
var $lattyware$elm_fontawesome$FontAwesome$Solid$eraser = A5(
	$lattyware$elm_fontawesome$FontAwesome$Icon$Icon,
	'fas',
	'eraser',
	512,
				...
				[
					...
					_List_fromArray(
						[
							...
							$elm$core$String$fromInt(model.by)),
...
var $author$project$GossipGraph$Call$renderString = F2(
	function (agents, call) {
		...
		if ((!_v0.a.$) && (!_v0.b.$)) {
			var from = _v0.a.a;
			var to = _v0.b.a;
			return $elm$core$String$fromChar(from.c0) + (' 📞 ' + $elm$core$String$fromChar(to.c0));
		} else {
			return '❌';
		}
	});
						...
						[
							...
							_List_fromArray(
								[
									...
									_Utils_Tuple2('current', !model.ad)
								])),
				...
				if (!_v1.$) {
					...
					return A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick(
								$author$project$Main$TimeTravel(n.fq)),
								$elm$html$Html$Attributes$classList(
								_List_fromArray(
									[
										_Utils_Tuple2('call', true),
										_Utils_Tuple2(
										'current',
										_Utils_eq(model.ad, n.fq))
									]))
							]),
						_List_fromArray(
							[
								$elm$html$Html$text(
								A2($author$project$GossipGraph$Call$renderString, agents, n.dM))
							]));
				} else {
					return A2(
						$elm$html$Html$div,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$type_('button'),
										$elm$html$Html$Attributes$title('Clear the call history'),
										$elm$html$Html$Events$onClick($author$project$Main$ClearExecutionTree)
									]),
								_List_fromArray(
									[
										$lattyware$elm_fontawesome$FontAwesome$Icon$viewIcon($lattyware$elm_fontawesome$FontAwesome$Solid$eraser)
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$type_('button'),
										$elm$html$Html$Attributes$title('Generate an execution tree'),
										$elm$html$Html$Events$onClick(
										A2(
											$author$project$Main$ShowModal,
											'Execution Tree',
			...
			[
				...
				_List_fromArray(
					[
						...
						_Utils_Tuple2('visible', model.W.bo)
					]))
			]),
		_List_fromArray(
			[
...
var $author$project$Main$ToggleConnective = function (a) {
	return {$: 3, a: a};
};
var $author$project$Main$TogglePopover = {$: 6};
var $author$project$Main$AppendConstituent = function (a) {
	return {$: 7, a: a};
};
var $elm$html$Html$sub = _VirtualDom_node('sub');
var $author$project$Main$renderProtocolConstituent = function (constituent) {
	switch (constituent) {
		case 2:
			return A2(
				$elm$html$Html$span,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('protocol-constituent')
					]),
				_List_fromArray(
					[
...
var $author$project$Main$addProtocolConstituentButton = function (constituent) {
	return A2(
		$elm$html$Html$button,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$type_('button'),
				$elm$html$Html$Events$onClick(
				$author$project$Main$ProtocolMessage(
					$author$project$Main$AppendConstituent(
						A2($author$project$GossipProtocol$BooleanFormula$Constituent, 1, constituent))))
			]),
		_List_fromArray(
			[
				$author$project$Main$renderProtocolConstituent(constituent)
			]));
};
...
var $author$project$Main$deleteButton = function (id) {
	return A2(
		$elm$html$Html$button,
		_List_fromArray(
			[
				$elm$html$Html$Events$onClick(
				$author$project$Main$ProtocolMessage(
					$author$project$Main$DeleteNode(id))),
				$elm$html$Html$Attributes$class('delete-constituent')
			]),
		_List_fromArray(
			[
...
var $author$project$Main$ClearDragFocus = {$: 2};
var $author$project$Main$SetDragFocus = function (a) {
	return {$: 1, a: a};
};
var $lattyware$elm_fontawesome$FontAwesome$Solid$gripVertical = A5(
	$lattyware$elm_fontawesome$FontAwesome$Icon$Icon,
	'fas',
	'grip-vertical',
	320,
...
var $author$project$Main$dragHandle = function (index) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('drag-handle'),
				$elm$html$Html$Events$onMouseOver(
				$author$project$Main$ProtocolMessage(
					$author$project$Main$SetDragFocus(index))),
				$elm$html$Html$Events$onMouseLeave(
				$author$project$Main$ProtocolMessage($author$project$Main$ClearDragFocus))
			]),
		_List_fromArray(
			[
...
var $norpan$elm_html5_drag_drop$Html5$DragDrop$onWithOptions = F3(
	function (name, _v0, decoder) {
		var stopPropagation = _v0.dx;
		var preventDefault = _v0.dh;
		return A2(
			...
			A2(
				$elm$json$Json$Decode$map,
				function (msg) {
					return {aF: msg, dh: preventDefault, dx: stopPropagation};
				},
				decoder));
	});
...
var $norpan$elm_html5_drag_drop$Html5$DragDrop$Position = F4(
	function (width, height, x, y) {
		return {d0: height, eX: width, aa: x, ab: y};
	});
...
var $author$project$Main$isDragFocus = F2(
	function (index, dragFocus) {
		if (dragFocus.$ === 1) {
			...
			var i = dragFocus.a;
			return _Utils_eq(index, i);
		}
	});
var $author$project$Main$ToggleNegation = function (a) {
	return {$: 5, a: a};
};
var $elm$html$Html$Attributes$checked = $elm$html$Html$Attributes$boolProperty('checked');
var $author$project$Main$negationToggle = F2(
	function (id, negationState) {
		var isChecked = !negationState;
		return A2(
			$elm$html$Html$input,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$type_('checkbox'),
					$elm$html$Html$Attributes$class('negation'),
					$elm$html$Html$Attributes$checked(isChecked),
					$elm$html$Html$Events$onClick(
					$author$project$Main$ProtocolMessage(
						$author$project$Main$ToggleNegation(id)))
				]),
			_List_Nil);
	});
...
var $author$project$Main$protocolHelpView = _List_fromArray(
	[
		...
		_List_fromArray(
			[
				$elm$html$Html$text('This section allows you to select one of the gossip protocols as defined in the paper '),
				A2(
				$elm$html$Html$a,
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Dynamic Gossip')
					])),
				$elm$html$Html$text(' by Van Ditmarsch et al. (2018). When you have selected a protocol, the possible calls for that protocol and the current gossip graph, together with the call history, will be shown. '),
				$elm$html$Html$text('Clicking the '),
				A2(
				$elm$html$Html$code,
				_List_Nil,
		...
		_List_fromArray(
			[
				$elm$html$Html$text('Until all agents are experts, select x, y ∈ A, such that x ≠ y, Nxy, and π(x, y), and execute call x y.')
			])),
		A2(
		$elm$html$Html$p,
		_List_Nil,
		_List_fromArray(
			[
				$elm$html$Html$text('Or, more informally: ')
			])),
		A2(
		$elm$html$Html$blockquote,
		_List_Nil,
		_List_fromArray(
			[
				$elm$html$Html$text('Until all agents know all secrets, and while there still is a distinct pair of agents (x, y) where x knows the number of y, and the protocol condition π(x, y) holds, let x call y.')
			])),
		A2(
		$elm$html$Html$p,
		_List_Nil,
		_List_fromArray(
			[
				$elm$html$Html$text('These definitions are due to '),
				A2(
				$elm$html$Html$a,
				_List_fromArray(
					[
...
var $author$project$Main$protocolView = function (model) {
	var transform = F4(
		function (id, label, left, right) {
			var junctionToString = function (j) {
				return (!j) ? '∧' : '∨';
			};
			var droppability = function () {
				...
				if (!_v5.$) {
					return A2(
						...
						function (msg) {
							return $author$project$Main$ProtocolMessage(
								$author$project$Main$DragDropMsg(msg));
						},
						id);
				} else {
					return _List_Nil;
			...
			var draggability = A2($author$project$Main$isDragFocus, id, model.a3) ? A2(
			...
			if (!label.$) {
				...
				return _List_fromArray(
					[
						A2(
						$elm$html$Html$ul,
						_Utils_ap(draggability, droppability),
						_List_fromArray(
							[
								$author$project$Main$dragHandle(id),
								A2(
								$elm$html$Html$div,
								_List_fromArray(
									[
								...
								_List_fromArray(
									[
										A2($elm$html$Html$li, _List_Nil, left),
										A2(
										$elm$html$Html$li,
										_List_fromArray(
											[
												$elm$html$Html$Attributes$class('junction'),
												$elm$html$Html$Events$onClick(
												$author$project$Main$ProtocolMessage(
													$author$project$Main$ToggleConnective(id)))
											]),
										_List_fromArray(
											[
												$elm$html$Html$text(
												junctionToString(junction))
											])),
										A2($elm$html$Html$li, _List_Nil, right)
									]))
							]))
					]);
			} else {
				...
				return A2(
					...
					A2(
						...
						A2(
							$elm$core$List$cons,
							$elm$html$Html$Attributes$class('constituent'),
							_Utils_ap(draggability, droppability)),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$author$project$Main$dragHandle(id),
										A2($author$project$Main$negationToggle, id, negation)
									])),
								$author$project$Main$renderProtocolConstituent(value),
								$author$project$Main$deleteButton(id)
							])),
					_Utils_ap(left, right));
			}
		});
	var protocolExplanation = function () {
		var _v3 = A2($elm$core$Dict$get, model.I, $author$project$GossipProtocol$Conditions$Predefined$explanation);
		if (!_v3.$) {
			...
			return _List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text('This protocol is defined as follows:')
						])),
					A2(
					$elm$html$Html$blockquote,
					_List_Nil,
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$text('Based on the definition in '),
											A2(
											$elm$html$Html$a,
											_List_fromArray(
												[
			...
			return (model.I === 'custom') ? _List_fromArray(
				[
					A2(
					$elm$html$Html$p,
					_List_Nil,
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$id('protocol-builder')
					]),
				A3($author$project$GossipProtocol$BooleanFormula$cata, transform, _List_Nil, model.E)),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$id('add-protocol-component')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Attributes$class('icon'),
								$elm$html$Html$Events$onClick(
								$author$project$Main$ProtocolMessage($author$project$Main$TogglePopover))
							]),
						_List_fromArray(
							[
								$lattyware$elm_fontawesome$FontAwesome$Icon$viewIcon($lattyware$elm_fontawesome$FontAwesome$Solid$plus),
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$id('constituent-popover'),
						$elm$html$Html$Attributes$classList(
						_List_fromArray(
							[
								_Utils_Tuple2('visible', model.a2)
							]))
					]),
				_List_fromArray(
					[
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$text('Constituents')
											])),
										A2(
										$elm$html$Html$button,
										_List_fromArray(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('constituents')
									]),
								_List_fromArray(
									[
										$author$project$Main$addProtocolConstituentButton(0),
										$author$project$Main$addProtocolConstituentButton(1),
										$author$project$Main$addProtocolConstituentButton(2),
										$author$project$Main$addProtocolConstituentButton(3),
										$author$project$Main$addProtocolConstituentButton(4),
										$author$project$Main$addProtocolConstituentButton(5),
										$author$project$Main$addProtocolConstituentButton(6),
										$author$project$Main$addProtocolConstituentButton(7)
									]))
							]))
					])),
				A2(
				...
				_List_fromArray(
					[
						...
						function () {
							var _v0 = A2($elm$core$Dict$get, model.I, $author$project$GossipProtocol$Conditions$Predefined$name);
							if (!_v0.$) {
								var name = _v0.a;
				...
				function () {
					var _v1 = _Utils_Tuple2(model.aO, model.t);
					if ((!_v1.a.$) && (!_v1.b.$)) {
						var agents = _v1.a.a;
						var graph = _v1.b.a;
						var calls = A3(
							...
							A3(
								...
								F2(
									function (el, acc) {
										if (el.$ === 1) {
											var n = el.a;
											return A2($elm$core$List$cons, n.dM, acc);
										} else {
											return acc;
										}
									}),
								_List_Nil,
								$zwilias$elm_rosetree$Tree$flatten(model.u)));
						return $elm$core$String$isEmpty(model.ae) ? _List_fromArray(
							[
...
var $author$project$Main$main = $elm$browser$Browser$document(
	{fr: $author$project$Main$init, fT: $author$project$Main$subscriptions, f1: $author$project$Main$update, f2: $author$project$Main$view});
/*
